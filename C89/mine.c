...
static double AUTO_arr[2000] = {0};
static double BCOLOR_arr[2000] = {0};
static double CLRLIN_arr[2000] = {0};
static double CURSOR_arr[2000] = {0};
static double EVENT_arr[2000] = {0};
static double FCOLOR_arr[2000] = {0};
static double FLAG_arr[2000] = {0};
static double HIT_arr[2000] = {0};
static double LCASE_arr[2000] = {0};
static double PRTMID_arr[2000] = {0};
static double TBOX_arr[2000] = {0};
static double VISADJ_arr[2000] = {0};
