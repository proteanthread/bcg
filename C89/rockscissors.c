...
line_60:;
    G = 1; for_loop_G_60: if (((1) >= 0 && G > (Q)) || ((1) < 0 && G < (Q))) goto end_for_G_60;
...
line_130:;
    switch ((int)(X)) {     case 1: goto line_140;     case 2: goto line_150;     case 3: goto line_160; }
...
line_250:;
    ...
    /* BASIC: 260 NEXT G */
line_260:;
    G += (1); goto for_loop_G_60; end_for_G_60:;
