...
/* Global variables */
static double C, D, E, F, G, H, I, K, L, M, N, P, Q, R, T, X, Y, Z;
...
line_220:;
    R = 1; for_loop_R_220: if (((1) >= 0 && R > (5)) || ((1) < 0 && R < (5))) goto end_for_R_220;
    printf("\n");
    R += (1); goto for_loop_R_220; end_for_R_220:;
    /* BASIC: 260 DIM M(100) */
line_260:;
    /* DIM M(100) (handled statically) */
    /* BASIC: 270 FOR R=1 TO 5 */
line_270:;
    R = 1; for_loop_R_270: if (((1) >= 0 && R > (5)) || ((1) < 0 && R < (5))) goto end_for_R_270;
    /* BASIC: 280 I=(R-1)*5+1 */
line_280:;
    I = (R-1)*5+1;
...
line_290:;
    ...
    /* BASIC: 300 NEXT R */
line_300:;
    R += (1); goto for_loop_R_270; end_for_R_270:;
    /* BASIC: 350 FOR R=1 TO 10: PRINT: NEXT R */
line_350:;
    R = 1; for_loop_R_350: if (((1) >= 0 && R > (10)) || ((1) < 0 && R < (10))) goto end_for_R_350;
    printf("\n");
    R += (1); goto for_loop_R_350; end_for_R_350:;
...
line_490:;
    printf("? "); if (fgets(_input_buf, sizeof(_input_buf), stdin)) sscanf(_input_buf, "%lf %lf %lf %lf", &G, &H, &K, &L);
    /* BASIC: 495 PRINT */
line_495:;
    printf("\n");
...
line_670:;
    printf("%s", "I MISSED YOU, YOU DIRTY RAT. I PICKED"); printf("%g ", (double)(M)); printf("%s", ". YOUR TURN:"); printf("\n");
...
line_1180:;
    T = 1; for_loop_T_1180: if (((1) >= 0 && T > (N)) || ((1) < 0 && T < (N))) goto end_for_T_1180;
    /* BASIC: 1190 IF M=M(T) THEN 570 */
line_1190:;
    if (M==M_arr[(int)(T)]) { goto line_570; }
    /* BASIC: 1200 NEXT T */
line_1200:;
    T += (1); goto for_loop_T_1180; end_for_T_1180:;
    /* BASIC: 1210 X=M */
line_1210:;
    X = M;
    /* BASIC: 1220 M(P)=M */
