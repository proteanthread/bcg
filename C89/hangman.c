...
static DataItem program_data[50] = {
    ...
    { DATA_STR, 0.0, "ESCORT" },
    { DATA_STR, 0.0, "PICKAX" },
    { DATA_STR, 0.0, "EXAMPLE" },
    { DATA_STR, 0.0, "TENSION" },
    { DATA_STR, 0.0, "QUININE" },
    { DATA_STR, 0.0, "KIDNEY" },
    { DATA_STR, 0.0, "REPLICA" },
    { DATA_STR, 0.0, "SLEEPER" },
    { DATA_STR, 0.0, "TRIANGLE" },
    { DATA_STR, 0.0, "KANGAROO" },
    { DATA_STR, 0.0, "MAHOGANY" },
    { DATA_STR, 0.0, "SERGEANT" },
    { DATA_STR, 0.0, "SEQUENCE" },
    { DATA_STR, 0.0, "MOUSTACHE" },
    { DATA_STR, 0.0, "DANGEROUS" },
    { DATA_STR, 0.0, "SCIENTIST" },
    { DATA_STR, 0.0, "DIFFERENT" },
    { DATA_STR, 0.0, "QUIESCENT" },
    { DATA_STR, 0.0, "MAGISTRATE" },
    { DATA_STR, 0.0, "ERRONEOUSLY" },
    { DATA_STR, 0.0, "LOUDSPEAKER" },
    { DATA_STR, 0.0, "PHYTOTOXIC" },
    { DATA_STR, 0.0, "MATRIMONIAL" },
    { DATA_STR, 0.0, "PARASYMPATHOMIMETIC" },
    { DATA_STR, 0.0, "THIGMOTROPISM" },
};
...
static double U_arr[2000] = {0};
static char D_str_arr[1000][64] = {0};
static char L_str_arr[1000][64] = {0};
static char N_str_arr[1000][64] = {0};
