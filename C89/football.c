...
static DataItem program_data[60] = {
    ...
    { DATA_NUM, 16.0, NULL },
    { DATA_NUM, 3.0, NULL },
    { DATA_STR, 0.0, "PITCHOUT" },
    { DATA_STR, 0.0, "TRIPLE REVERSE" },
    { DATA_STR, 0.0, "DRAW" },
    { DATA_STR, 0.0, "QB SNEAK" },
    { DATA_STR, 0.0, "END AROUND" },
    { DATA_STR, 0.0, "DOUBLE REVERSE" },
    { DATA_STR, 0.0, "LEFT SWEEP" },
    { DATA_STR, 0.0, "RIGHT SWEEP" },
    { DATA_STR, 0.0, "OFF TACKLE" },
    { DATA_STR, 0.0, "WISHBONE OPTION" },
    { DATA_STR, 0.0, "FLARE PASS" },
    { DATA_STR, 0.0, "SCREEN PASS" },
    { DATA_STR, 0.0, "ROLL OUT OPTION" },
    { DATA_STR, 0.0, "RIGHT CURL" },
    { DATA_STR, 0.0, "LEFT CURL" },
    { DATA_STR, 0.0, "WISHBONE OPTION" },
    { DATA_STR, 0.0, "SIDELINE PASS" },
    { DATA_STR, 0.0, "HALF-BACK OPTION" },
    { DATA_STR, 0.0, "RAZZLE-DAZZLE" },
    { DATA_STR, 0.0, "BOMB!!!!" },
};
...
static char M_str_arr[1000][64] = {0};
static char P_str_arr[1000][64] = {0};
