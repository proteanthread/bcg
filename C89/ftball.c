...
static DataItem program_data[20] = {
    { DATA_STR, 0.0, "KICK" },
    { DATA_STR, 0.0, "RECEIVE" },
    { DATA_STR, 0.0, " YARD " },
    { DATA_STR, 0.0, "RUN BACK FOR " },
    { DATA_STR, 0.0, "BALL ON " },
    { DATA_STR, 0.0, "YARD LINE" },
    { DATA_STR, 0.0, " SIMPLE RUN" },
    { DATA_STR, 0.0, " TRICKY RUN" },
    { DATA_STR, 0.0, " SHORT PASS" },
    { DATA_STR, 0.0, " LONG PASS" },
    { DATA_STR, 0.0, "PUNT" },
    { DATA_STR, 0.0, " QUICK KICK " },
    { DATA_STR, 0.0, " PLACE KICK" },
    { DATA_STR, 0.0, " LOSS " },
    { DATA_STR, 0.0, " NO GAIN" },
    { DATA_STR, 0.0, "GAIN " },
    { DATA_STR, 0.0, " TOUCHDOWN " },
    { DATA_STR, 0.0, " TOUCHBACK " },
    { DATA_STR, 0.0, "SAFETY***" },
    { DATA_STR, 0.0, "JUNK" },
};
...
static char O_str_arr[1000][64] = {0};
