...
int main(int argc, char **argv) {
    ...
    double A8, ENTER, YEARS, HAPPY, READ, FACTS, MONDAY, SATURDAY, DAYS, NEW, ABOUT, TUESDAY, WORKED, THIRTEENTH, RELAXED, JERSEY, THE, PLAYED, WEEKDAY, BIRTH, M1, A, TODAY, D, MONTHS, MDLXXXII, EATEN, SLEPT, IN, DEF, FORM, MORRISTOWN, I7, DATA, WAS, THURSDAY, BIRTHDATE, Y2, Y3, BEWARE, STUDIED, PRIOR, LET, INTEREST, YOUR, I, Y, M, FNA, WEDNESDAY, IS, BIRTHDAY, WEEK, OF, RETIRE, I6, DEMONSTRATION, S, WILL, CREATIVE, COMPUTER, I5, I2, YOU, K1, Y1, DAY, OTHER, T1, AGE, K6, MAY, FRIDAY, I1, BE, B, FNB, SUNDAY, COMPUTING, K7, E, GIVE, GIVES, PREPARED, DATE, F, THAT, D1, K5, HAVE;
...
line_140:
    printf("? "); if (fgets(_input_buf, sizeof(_input_buf), stdin)) sscanf(_input_buf, "%lf", &M1,D1,Y1);
...
line_250:
    printf("? "); if (fgets(_input_buf, sizeof(_input_buf), stdin)) sscanf(_input_buf, "%lf", &M,D,Y);
    /* BASIC: 260 PRINT */
line_260:
    printf("\n");
...
line_270:
    ...
    /* BASIC: 280 REM TEST FOR DATE BEFORE CURRENT CALENDAR. */
line_280:
