...
int main(int argc, char **argv) {
    ...
    double GOING, FACE, NOW, MANS, P, JAW, ROUNDS, J, NEW, COLD, NICE, SWINGS, JERSEY, THE, ADVANTAGE, A, D, RIGHT, BUT, IT, GOODBYE, DIFFERENT, BLOCKED, ARENA, HOOK, R1, FULL, IN, HIM, BLOCK, BEGINS, OUT, BY, OUCH, MORRISTOWN, AMAZINGLY, KNOCKED, BOXING, JABS, Z4, OH, R6, SPILLS, WHAT, PUNCH, BLOOD, ATTACKED, OLYMPIC, SWING, YOUR, I, HE, MAN, H1, BLOCKS, FROM, Y, J7, IS, VULNERABILITY, ROUND, OF, UPPERCUT, B1, BEST, S, MISSES, CREATIVE, HIS, X, WINS, NAME, WITH, WINNER, D5, Q4, CONNECTS, OPPONENT, AN, ARE, B, C, HEAD, SECRET, POW, COMPUTING, JAB, CHAMP, GIVES, GETS, AT, L, TAKES, STYLE, AGAIN, R, LUCKY, D1, TRIES, X3, HITS, PUNCHES;
    char _input_buf[256];
...
line_130:
    R = 1; for_loop_R: if ((1 >= 0 && R > 3) || (1 < 0 && R < 3)) goto end_for_R;
...
line_185:
    R1 = 1; for_loop_R1: if ((1 >= 0 && R1 > 7) || (1 < 0 && R1 < 7)) goto end_for_R1;
...
line_270:
    printf("%s", L_str); printf("%s", " JABS AT "); printf("%g ", (double)(J$"'S HEAD "));
...
line_520:
    printf("%g ", (double)(L$ " TRIES AN UPPERCUT "));
...
line_720:
    printf("%g ", (double)(J$" TAKES A FULL SWING AND"));
...
line_940:
    ...
    /* BASIC: 950 NEXT R1 */
line_950:
    R1 += 1; goto for_loop_R1; end_for_R1:;
...
line_952:
    printf("\n");
    printf("%g ", (double)(J$" WINS ROUND" R)); printf("\n");
    /* BASIC: 953 J=J+1 */
line_953:
    J = J+1;
    /* BASIC: 954 GOTO 960 */
...
line_955:
    printf("\n");
    printf("%g ", (double)(L$" WINS ROUND"R)); printf("\n");
    /* BASIC: 956 L=L+1 */
line_956:
    L = L+1;
    /* BASIC: 960 NEXT R */
...
line_980:
    printf("%g ", (double)(J$ " IS KNOCKED COLD && " L$" IS THE WINNER && CHAMP!"));
    /* BASIC: 1000 GOTO 1080 */
line_1000:
    goto line_1080;
    /* BASIC: 1010 PRINT L$ " IS KNOCKED COLD AND " J$" IS THE WINNER AND CHAMP!"; */
line_1010:
    printf("%g ", (double)(L$ " IS KNOCKED COLD && " J$" IS THE WINNER && CHAMP!"));
    /* BASIC: 1030 GOTO 1000 */
line_1030:
    goto line_1000;
    /* BASIC: 1040 PRINT J$ " WINS (NICE GOING," J$;")." */
line_1040:
    printf("%s", J$ " WINS (NICE GOING," J_str); printf("%s", ")."); printf("\n");
    /* BASIC: 1050 GOTO 1000 */
line_1050:
    goto line_1000;
    /* BASIC: 1060 PRINT L$ " AMAZINGLY WINS!!" */
line_1060:
    printf("%g ", (double)(L$ " AMAZINGLY WINS!!")); printf("\n");
