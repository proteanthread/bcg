...
int main(int argc, char **argv) {
    ...
    double MINIMUM, DOLLAR, ORANGE, FROM, ARE, M, Y, BANDITS, MORRISTOWN, LEMON, P, CHR, BET, H, CASINO, IS, NEW, DOUBLE, KEY, OUR, OF, Z, SLOTS, LOST, COMPUTING, CREATIVE, JERSEY, THE, MONEY, JACKPOT, HOUSE, HEY, BAR, BELL, T8, PLEASE, YOU, ON, WINNINGS, X, TOP, CHERRY, A, EVEN, COLLECT, LEAVE, PUNCH, UP, TERMINAL, WON, ONE, AGAIN, PAY, LIMITS, AFTER, MAKING, STANDINGS, LET, BROKE, Q4, PULL, PLUM, ARM, YOUR, FRONT, IN, CASHIER;
    char _input_buf[256];
...
line_510:
    printf("%g ", (double)("YOUR STANDINGS ARE $"P)); printf("\n");
...
line_1270:
    Q4 = 1; for_loop_Q4: if ((1 >= 0 && Q4 > 10) || (1 < 0 && Q4 < 10)) goto end_for_Q4;
    /* BASIC: 1280 PRINT CHR$(7); */
line_1280:
    printf("%g ", (double)(CHR$(7)));
    /* BASIC: 1290 NEXT Q4 */
line_1290:
    Q4 += 1; goto for_loop_Q4; end_for_Q4:;
    /* BASIC: 1300 RETURN */
line_1300:
    /* TODO: RETURN */
    /* BASIC: 1310 FOR T8=1 TO 5 */
line_1310:
    T8 = 1; for_loop_T8: if ((1 >= 0 && T8 > 5) || (1 < 0 && T8 < 5)) goto end_for_T8;
    /* BASIC: 1320 PRINT CHR$(7); */
line_1320:
    printf("%g ", (double)(CHR$(7)));
    /* BASIC: 1330 NEXT T8 */
line_1330:
    T8 += 1; goto for_loop_T8; end_for_T8:;
    /* BASIC: 1340 RETURN */
line_1340:
    /* TODO: RETURN */
