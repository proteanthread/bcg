...
static DataItem program_data[84] = {
    { DATA_STR, { .str = "BULL RUN" } },
    { DATA_NUM, { .num = 18000.0 } },
    { DATA_NUM, { .num = 18500.0 } },
    { DATA_NUM, { .num = 1967.0 } },
    { DATA_NUM, { .num = 2708.0 } },
    { DATA_NUM, { .num = 1.0 } },
    { DATA_STR, { .str = "SHILOH" } },
    { DATA_NUM, { .num = 40000.0 } },
    { DATA_NUM, { .num = 44894.0 } },
    { DATA_NUM, { .num = 10699.0 } },
    { DATA_NUM, { .num = 13047.0 } },
    { DATA_NUM, { .num = 3.0 } },
    { DATA_STR, { .str = "SEVEN DAYS" } },
    { DATA_NUM, { .num = 95000.0 } },
    { DATA_NUM, { .num = 115000.0 } },
    { DATA_NUM, { .num = 20614.0 } },
    { DATA_NUM, { .num = 15849.0 } },
    { DATA_NUM, { .num = 3.0 } },
    { DATA_STR, { .str = "SECOND BULL RUN" } },
    { DATA_NUM, { .num = 54000.0 } },
    { DATA_NUM, { .num = 63000.0 } },
    { DATA_NUM, { .num = 10000.0 } },
    { DATA_NUM, { .num = 14000.0 } },
    { DATA_NUM, { .num = 2.0 } },
    { DATA_STR, { .str = "ANTIETAM" } },
    { DATA_NUM, { .num = 40000.0 } },
    { DATA_NUM, { .num = 50000.0 } },
    { DATA_NUM, { .num = 10000.0 } },
    { DATA_NUM, { .num = 12000.0 } },
    { DATA_NUM, { .num = 3.0 } },
    { DATA_STR, { .str = "FREDERICKSBURG" } },
    { DATA_NUM, { .num = 75000.0 } },
    { DATA_NUM, { .num = 120000.0 } },
    { DATA_NUM, { .num = 5377.0 } },
    { DATA_NUM, { .num = 12653.0 } },
    { DATA_NUM, { .num = 1.0 } },
    { DATA_STR, { .str = "MURFREESBORO" } },
    { DATA_NUM, { .num = 38000.0 } },
    { DATA_NUM, { .num = 45000.0 } },
    { DATA_NUM, { .num = 11000.0 } },
    { DATA_NUM, { .num = 12000.0 } },
    { DATA_NUM, { .num = 1.0 } },
    { DATA_STR, { .str = "CHANCELLORSVILLE" } },
    { DATA_NUM, { .num = 32000.0 } },
    { DATA_NUM, { .num = 90000.0 } },
    { DATA_NUM, { .num = 13000.0 } },
    { DATA_NUM, { .num = 17197.0 } },
    { DATA_NUM, { .num = 2.0 } },
    { DATA_STR, { .str = "VICKSBURG" } },
    { DATA_NUM, { .num = 50000.0 } },
    { DATA_NUM, { .num = 70000.0 } },
    { DATA_NUM, { .num = 12000.0 } },
    { DATA_NUM, { .num = 19000.0 } },
    { DATA_NUM, { .num = 1.0 } },
    { DATA_STR, { .str = "GETTYSBURG" } },
    { DATA_NUM, { .num = 72500.0 } },
    { DATA_NUM, { .num = 85000.0 } },
    { DATA_NUM, { .num = 20000.0 } },
    { DATA_NUM, { .num = 23000.0 } },
    { DATA_NUM, { .num = 3.0 } },
    { DATA_STR, { .str = "CHICKAMAUGA" } },
    { DATA_NUM, { .num = 66000.0 } },
    { DATA_NUM, { .num = 60000.0 } },
    { DATA_NUM, { .num = 18000.0 } },
    { DATA_NUM, { .num = 16000.0 } },
    { DATA_NUM, { .num = 2.0 } },
    { DATA_STR, { .str = "CHATTANOOGA" } },
    { DATA_NUM, { .num = 37000.0 } },
    { DATA_NUM, { .num = 60000.0 } },
    { DATA_NUM, { .num = 36700.0 } },
    { DATA_NUM, { .num = 5800.0 } },
    { DATA_NUM, { .num = 2.0 } },
    { DATA_STR, { .str = "SPOTSYLVANIA" } },
    { DATA_NUM, { .num = 62000.0 } },
    { DATA_NUM, { .num = 110000.0 } },
    { DATA_NUM, { .num = 17723.0 } },
    { DATA_NUM, { .num = 18000.0 } },
    { DATA_NUM, { .num = 2.0 } },
    { DATA_STR, { .str = "ATLANTA" } },
    { DATA_NUM, { .num = 65000.0 } },
    { DATA_NUM, { .num = 100000.0 } },
    { DATA_NUM, { .num = 8500.0 } },
    { DATA_NUM, { .num = 3700.0 } },
    { DATA_NUM, { .num = 1.0 } },
};
...
static double C1_arr[20000] = {0};
static double C2_arr[20000] = {0};
static double D_arr[20000] = {0};
static double F_arr[20000] = {0};
static double H_arr[20000] = {0};
static double M_arr[20000] = {0};
static double M1_arr[20000] = {0};
static double M2_arr[20000] = {0};
static double O_arr[20000] = {0};
static double S_arr[20000] = {0};
static double S2_arr[20000] = {0};
static char C_str_arr[20000][256] = {0};
