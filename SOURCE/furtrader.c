...
int main(int argc, char **argv) {
    ...
    double FURS, AMONG, AVERAGE, DISTRIBUTED, READ, CHEAT, SELL, NOW, THAN, P, GAME, INCLUDING, J, NEW, IROQUOIS, LEAVING, HIGHER, CARRY, HOCHELAGA, ANSWER, JERSEY, THE, DAMAGED, PREVIOUS, ON, YORK, FORTS, M1, A, KILLED, FORT, DEPEND, BUT, WHEN, IT, DIFFICULT, CONTROL, LEADER, BEHIND, WERE, FAR, HAD, EXPEDITION, IN, TRADING, FOUND, EASIER, BY, E1, PARTY, MORRISTOWN, ANY, DATA, MINK, LOW, ADD, CHOICE, AREA, BEAVER, MUST, ROUTE, COMPARSION, UNDER, START, PEOPLE, ARMY, HOWEVER, ACROSS, LAKE, THEM, KINDS, TRY, PROTECTION, THESE, THREE, ATTACKED, QUEBEC, RAPIDS, WANT, FRENCH, TRADER, LET, RESTORE, CHOSEN, RECEIVE, TOO, ALL, YOUR, I, EXPENSES, RAIDING, HARDER, RETURNED, THROUGH, SAFELY, FROM, COST, VALUE, IS, OF, ONLY, B1, GROUP, BEGIN, NARROWLY, WILL, MONTREAL, CURED, CREATIVE, ARRIVED, LOWER, FOX, YOU, STADACONA, NO, LEAVE, ONTARIO, ONE, ERMINE, ANOTHER, OTHER, PROPERLY, YEAR, PRICE, SEAPORT, LACHINE, STOLEN, HARD, BUY, AN, MAY, CHOOSE, HEAVY, PELTS, ARE, BE, ENDS, HIGHEST, B, HOW, AMOUNT, MAKE, DUTCH, CURRENT, WISH, SOLD, FUR, CAN, ESCAPED, LAND, TRIP, LOST, WHICH, COMPUTING, MOST, GET, HALF, TRAVEL, SAVINGS, PORTAGE, CROSS, MANY, AT, FOLLOWING, DO, AGAIN, THAT, YES, EASIEST, CANOE, LUCKY, SUPPLIES, D1, HAVE, THIS, UPSET, TRADE;
...
line_101:
    printf("%s", "YOU HAVE $"); printf("%g ", (double)(I " SAVINGS.")); printf("\n");
...
line_1412:
    printf("%s", "YOUR BEAVER SOLD FOR $"); printf("%g ", (double)(B1*F(2)));
    /* BASIC: 1414 PRINT "YOUR FOX SOLD FOR $";D1*F(4) */
line_1414:
    printf("%s", "YOUR FOX SOLD FOR $"); printf("%g ", (double)(D1*F(4))); printf("\n");
    /* BASIC: 1416 PRINT "YOUR ERMINE SOLD FOR $";E1*F(3); */
line_1416:
    printf("%s", "YOUR ERMINE SOLD FOR $"); printf("%g ", (double)(E1*F(3)));
    /* BASIC: 1417 PRINT "YOUR MINK SOLD FOR $";M1*F(1) */
line_1417:
    printf("%s", "YOUR MINK SOLD FOR $"); printf("%g ", (double)(M1*F(1))); printf("\n");
