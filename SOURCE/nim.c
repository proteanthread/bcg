...
int main(int argc, char **argv) {
    ...
    double OBJECTS, WINNING, ENTER, GAME, J, NEW, INSTRUCTIONS, AVOID, ANSWER, THE, JERSEY, PLAYED, ON, D, LOSES, DIFFERENT, IN, NUMBER, BY, MORRISTOWN, NIM, ANY, PILES, TAKE, LISTING, MUST, WHETHER, SINGLE, TURN, PLAY, OPTION, WANT, LET, ALL, YOUR, I, SHOW, FROM, Y, W, H, IS, OF, Z, ONLY, ORIGINALLY, OBJECT, ITS, WILL, CREATIVE, WIN, SIZES, MACHINE, EACH, PLEASE, YOU, X, WINS, LEAST, AS, NO, WITH, ONE, ANOTHER, TAKING, G, SIZE, LAST, SPECIFY, MAY, ARE, BE, B, MOVES, HOW, C, MOVE, ALTERNATELY, PILE, Q9, COMPUTING, E, MANY, AT, F, CONTAIN, DO, FIRST, THAT, YES, N, DEFINED, THIS;
...
line_580:
    if (A(I)>2000) goto line_560;
    /* BASIC: 590 IF A(I)<1 THEN 560 */
line_590:
    if (A(I)<1) goto line_560;
    /* BASIC: 600 IF A(I)<>INT(A(I)) THEN 560 */
line_600:
    if (A(I)!=floor(A(I))) goto line_560;
    /* BASIC: 610 NEXT I */
line_610:
...
line_620:
    ...
    /* BASIC: 630 INPUT Q9$ */
line_630:
    printf("? "); fgets(Q9_str, sizeof(Q9_str), stdin); Q9_str[strcspn(Q9_str, "\n")] = 0;
    /* BASIC: 640 IF Q9$="YES" THEN 1450 */
line_640:
    if (Q9$=="YES") goto line_1450;
    /* BASIC: 650 IF Q9$="yes" THEN 1450 */
line_650:
    if (Q9$=="yes") goto line_1450;
    /* BASIC: 660 IF Q9$="NO" THEN 700 */
line_660:
    if (Q9$=="NO") goto line_700;
...
line_860:
    if (A(I)>1) goto line_940;
    /* BASIC: 870 IF A(I)=0 THEN 890 */
line_870:
    if (A(I)==0) goto line_890;
    /* BASIC: 880 LET C=C+1 */
line_880:
    /* UNTRANSLATED: LET C=C+1 */
    /* BASIC: 890 NEXT I */
...
line_960:
    J = 0; for_loop_J: if ((1 >= 0 && J > 10) || (1 < 0 && J < 10)) goto end_for_J;
    /* BASIC: 970 LET F=E/2 */
line_970:
...
line_1020:
    J = 10; for_loop_J: if ((-1 >= 0 && J > 0) || (-1 < 0 && J < 0)) goto end_for_J;
    /* BASIC: 1030 LET C=0 */
line_1030:
    /* UNTRANSLATED: LET C=0 */
    /* BASIC: 1040 LET H=0 */
...
line_1320:
    if (A(I)>1) goto line_1380;
    /* BASIC: 1330 IF A(I)=0 THEN 1350 */
line_1330:
    if (A(I)==0) goto line_1350;
...
line_1400:
    printf("%g ", (double)(I)); printf("%g ", (double)(A(I))); printf("\n");
    /* BASIC: 1410 NEXT I */
line_1410:
    I += 1; goto for_loop_I; end_for_I:;
