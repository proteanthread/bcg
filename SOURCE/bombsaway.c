...
int main(int argc, char **argv) {
    ...
    double GOING, ENGLAND, SHOT, GERMAN, NOW, TRAINING, PERCENT, CHICKEN, ALLIES, FLOWN, RE, THEY, THE, PLOESTI, MISSILES, TONS, ON, A, LONDON, KAMIKAZE, KILLED, D, TODAY, BUT, IT, II, GUNNERS, PAY, NEARLY, PLANE, T, LIBERATOR, RUSSIA, IN, OUT, LIE, BY, GATHERED, BOMB, OLD, PILOT, TARGET, LEXINGTON, LANCASTER, OH, WAR, TRY, BOOM, PUSHING, CAREFUL, JAPAN, HERE, WHAT, NAZI, BOMBS, U, REALLY, ITALY, NORTH, OIL, DUCK, YOUR, WELL, THROUGH, WORLD, Y, M, BELOVED, AIRCRAFT, BEEN, IS, BISMARK, MILES, RADAR, ODDS, OF, OUR, TIMERS, LL, S, SOUP, YOU, MISSIONS, WATER, SHOULD, ENEMY, BOMBER, MISSED, EASY, TRIBUTE, FRANCE, ANOTHER, EH, SEA, WE, HIGH, BOTH, ALBANIA, DIRECT, GREECE, USS, FRESH, DEARLY, G, BUSTING, LAST, GOT, RUHR, HEAVY, ARE, BE, CHASING, B, STALINGRAD, HOW, GUNS, VERSAILLES, HIROSHIMA, NEARING, HIT, DEFENSELESS, VE, MISSION, GERMANY, SIDE, FLYING, MANY, EVEN, DOES, F, DOWN, AGAIN, FIRST, THAT, SUCCESSFUL, R, AFRICA, OVER, MADE, RATE, N, HAVE, DUMPING, PLANT;
    char _input_buf[256];
...
line_25:
    /* UNTRANSLATED: ON A GOTO 30, 110, 200, 220 */
...
line_45:
    printf("\n");
    /* UNTRANSLATED: ON B GOTO 50, 80,90 */
...
line_125:
    printf("\n");
    /* UNTRANSLATED: ON G GOTO 130, 150, 170, 190 */
...
line_205:
    printf("%s", "YOUR FIRST KAMIKAZE MISSION(Y OR N)"); fgets(F_str, sizeof(F_str), stdin); F_str[strcspn(F_str, "\n")] = 0;
...
line_235:
    printf("\n");
    /* UNTRANSLATED: ON M GOTO 250, 260, 270 */
...
line_325:
    printf("%s", "DIRECT HIT!!!! "INT(100*RND(1))"KILLED."); printf("\n");
...
line_330:
    printf("%s", "MISSED TARGET BY"INT(2+30*RND(1))"MILES!"); printf("\n");
...
line_390:
    ...
    printf("\n");
    printf("\n");
    printf("%s", "ANOTHER MISSION (Y OR N)"); fgets(U_str, sizeof(U_str), stdin); U_str[strcspn(U_str, "\n")] = 0;
