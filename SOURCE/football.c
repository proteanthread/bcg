...
static DataItem program_data[60] = {
    { DATA_NUM, { .num = 17.0 } },
    { DATA_NUM, { .num = 8.0 } },
    { DATA_NUM, { .num = 4.0 } },
    { DATA_NUM, { .num = 14.0 } },
    ...
    { DATA_NUM, { .num = 16.0 } },
    { DATA_NUM, { .num = 3.0 } },
    { DATA_STR, { .str = "PITCHOUT" } },
    { DATA_STR, { .str = "TRIPLE REVERSE" } },
    { DATA_STR, { .str = "DRAW" } },
    { DATA_STR, { .str = "QB SNEAK" } },
    { DATA_STR, { .str = "END AROUND" } },
    { DATA_STR, { .str = "DOUBLE REVERSE" } },
    { DATA_STR, { .str = "LEFT SWEEP" } },
    { DATA_STR, { .str = "RIGHT SWEEP" } },
    { DATA_STR, { .str = "OFF TACKLE" } },
    { DATA_STR, { .str = "WISHBONE OPTION" } },
    { DATA_STR, { .str = "FLARE PASS" } },
    { DATA_STR, { .str = "SCREEN PASS" } },
    { DATA_STR, { .str = "ROLL OUT OPTION" } },
    { DATA_STR, { .str = "RIGHT CURL" } },
    { DATA_STR, { .str = "LEFT CURL" } },
    { DATA_STR, { .str = "WISHBONE OPTION" } },
    { DATA_STR, { .str = "SIDELINE PASS" } },
    { DATA_STR, { .str = "HALF-BACK OPTION" } },
    { DATA_STR, { .str = "RAZZLE-DAZZLE" } },
    { DATA_STR, { .str = "BOMB!!!!" } },
};
...
static double A, B, C, D, E, F, G, H, I, K, L, N, P, P1, P2, Q, R, S, T, U, W, X, Y, Z;
...
static double H_arr[20000] = {0};
static double T_arr[20000] = {0};
static double W_arr[20000] = {0};
static double X_arr[20000] = {0};
static double Y_arr[20000] = {0};
static double Z_arr[20000] = {0};
...
line_160:;
    if (strcmp(A_str, "NO") == 0) { goto line_290; }
    /* BASIC: 165 IF A$<>"YES" THEN 150 */
line_165:;
    if (strcmp(A_str, "YES") != 0) { goto line_150; }
...
line_270:;
    ...
    /* BASIC: 280 PRINT "PLEASE PREPARE A TAPE AND RUN.": S TO P */
line_280:;
...
line_300:;
    I = 1; for_loop_I_300: if (((1) >= 0 && I > (40)) || ((1) < 0 && I < (40))) goto end_for_I_300;
    read_numeric(&N);
...
line_370:;
    I = 1; for_loop_I_370: if (((1) >= 0 && I > (20)) || ((1) < 0 && I < (20))) goto end_for_I_370;
    read_string(P_str_arr[(int)(I)], sizeof(P_str_arr[(int)(I)]));
...
line_430:;
    I = 1; for_loop_I_430: if (((1) >= 0 && I > (20)) || ((1) < 0 && I < (20))) goto end_for_I_430;
    /* BASIC: 440 REM */
line_440:;
    // REM
    /* BASIC: 450 PRINT C(I+L);TAB(6);P$(I) */
line_450:;
    printf("%g ", (double)(C_arr[(int)(I+L)])); { int _t; for(_t=0; _t<6; _t++) printf(" "); } printf("%s", P_str_arr[(int)(I)]); printf("\n");
    /* BASIC: 460 NEXT I */
line_460:;
    I += (1); goto for_loop_I_430; end_for_I_430:;
...
line_660:;
    X = 1; for_loop_X_660: if (((1) >= 0 && X > (11)) || ((1) < 0 && X < (11))) goto end_for_X_660;
    printf("\n");
    X += (1); goto for_loop_X_660; end_for_X_660:;
    /* BASIC: 670 FOR Z=1 TO 3000: NEXT Z */
line_670:;
    Z = 1; for_loop_Z_670: if (((1) >= 0 && Z > (3000)) || ((1) < 0 && Z < (3000))) goto end_for_Z_670;
    Z += (1); goto for_loop_Z_670; end_for_Z_670:;
...
line_690:;
    D_arr[(int)(1)] = 0;
    D_arr[(int)(2)] = 3;
    str_assign(M_str_arr[(int)(1)], sizeof(M_str_arr[(int)(1)]), "--->");
    str_assign(M_str_arr[(int)(2)], sizeof(M_str_arr[(int)(2)]), "<---");
...
line_725:;
    gosub_stack[gosub_sp++] = 1; goto line_1910; line_ret_1:;
...
line_765:;
    P = X_arr[(int)(T)]-Y_arr[(int)(T)]*40;
    /* BASIC: 770 GOSUB 1860: PRINT : PRINT "TEAM";T;"RECEIVES KICK-OFF" */
line_770:;
    gosub_stack[gosub_sp++] = 2; goto line_1860; line_ret_2:;
    printf("\n");
...
line_794:;
    if (W_arr[(int)(T)]*P<Z_arr[(int)(T)]+10) { goto line_810; }
...
line_810:;
    ...
    gosub_stack[gosub_sp++] = 3; goto line_1900; line_ret_3:;
...
line_840:;
    if (strcmp(A_str, "YES") == 0) { goto line_1430; }
    /* BASIC: 845 IF A$<>"NO" THEN 830 */
line_845:;
    if (strcmp(A_str, "NO") != 0) { goto line_830; }
    /* BASIC: 850 IF W(T)*P<Z(T) THEN 880 */
line_850:;
    if (W_arr[(int)(T)]*P<Z_arr[(int)(T)]) { goto line_880; }
    /* BASIC: 870 P=Z(T)-W(T)*20 */
line_870:;
    P = Z_arr[(int)(T)]-W_arr[(int)(T)]*20;
    /* BASIC: 880 D=1: S=P */
line_880:;
    D = 1;
    S = P;
...
line_885:;
    I = 1; for_loop_I_885: if (((1) >= 0 && I > (72)) || ((1) < 0 && I < (72))) goto end_for_I_885;
    printf("%s", "=");
    I += (1); goto for_loop_I_885; end_for_I_885:;
...
line_895:;
    if (Y_arr[(int)(T)]*(P+Y_arr[(int)(T)]*10)>=X_arr[(int)(T)]) { goto line_898; }
...
line_901:;
    { int _t; for(_t=0; _t<27; _t++) printf(" "); } printf("%g ", (double)(10-(Y_arr[(int)(T)]*P-Y_arr[(int)(T)]*S))); printf("%s", "YARDS TO 1ST DOWN"); printf("\n");
    /* BASIC: 902 GOTO 910 */
line_902:;
    goto line_910;
    /* BASIC: 904 PRINT TAB(27);X(T)-Y(T)*P;"YARDS" */
line_904:;
    { int _t; for(_t=0; _t<27; _t++) printf(" "); } printf("%g ", (double)(X_arr[(int)(T)]-Y_arr[(int)(T)]*P)); printf("%s", "YARDS"); printf("\n");
    /* BASIC: 910 GOSUB 1900: IF D=4 THEN 1180 */
line_910:;
    gosub_stack[gosub_sp++] = 4; goto line_1900; line_ret_4:;
...
line_960:;
    printf("? "); if (fgets(_input_buf, sizeof(_input_buf), stdin)) sscanf(_input_buf, "%lf %lf", &P1, &P2);
    goto line_975;
    /* BASIC: 970 INPUT P2,P1 */
line_970:;
    printf("? "); if (fgets(_input_buf, sizeof(_input_buf), stdin)) sscanf(_input_buf, "%lf %lf", &P2, &P1);
...
line_1000:;
    Y = floor(fabs(A_arr[(int)(P1)]-B_arr[(int)(P2)])/19*((X_arr[(int)(T)]-Y_arr[(int)(T)]*P+25)*((double)rand() / (double)RAND_MAX)-15));
...
line_1010:;
    if (A_arr[(int)(P1)]<11) { goto line_1048; }
    /* BASIC: 1012 GOTO 1020 */
line_1012:;
    goto line_1020;
    /* BASIC: 1015 IF B(P2)<11 THEN 1048 */
line_1015:;
    if (B_arr[(int)(P2)]<11) { goto line_1048; }
...
line_1080:;
    printf("\n");
    printf("%s", "** LOSS OF POSSESSION FROM TEAM"); printf("%g ", (double)(T)); printf("%s", "TO TEAM"); printf("%g ", (double)(T_arr[(int)(T)])); printf("\n");
    /* BASIC: 1100 GOSUB 1850: PRINT: T=T(T): GOTO 830 */
line_1100:;
    gosub_stack[gosub_sp++] = 5; goto line_1850; line_ret_5:;
    printf("\n");
    T = T_arr[(int)(T)];
    goto line_830;
    /* BASIC: 1110 IF Y(T)*P>=X(T) THEN 1320 */
line_1110:;
    if (Y_arr[(int)(T)]*P>=X_arr[(int)(T)]) { goto line_1320; }
    /* BASIC: 1120 IF W(T)*P>=Z(T) THEN 1230 */
line_1120:;
    if (W_arr[(int)(T)]*P>=Z_arr[(int)(T)]) { goto line_1230; }
    /* BASIC: 1130 IF Y(T)*P-Y(T)*S>=10 THEN 880 */
line_1130:;
    if (Y_arr[(int)(T)]*P-Y_arr[(int)(T)]*S>=10) { goto line_880; }
...
line_1170:;
    gosub_stack[gosub_sp++] = 6; goto line_1850; line_ret_6:;
    goto line_880;
...
line_1185:;
    if (strcmp(A_str, "NO") == 0) { goto line_1200; }
    /* BASIC: 1187 IF A$<>"YES" THEN 1180 */
line_1187:;
    if (strcmp(A_str, "YES") != 0) { goto line_1180; }
...
line_1195:;
    gosub_stack[gosub_sp++] = 7; goto line_1850; line_ret_7:;
...
line_1210:;
    if (strcmp(A_str, "YES") == 0) { goto line_1640; }
...
line_1240:;
    H_arr[(int)(T_arr[(int)(T)])] = H_arr[(int)(T_arr[(int)(T)])]+2;
    gosub_stack[gosub_sp++] = 8; goto line_1810; line_ret_8:;
...
line_1290:;
    P = Z_arr[(int)(T)]-W_arr[(int)(T)]*20;
    if (strcmp(A_str, "YES") == 0) { goto line_1190; }
...
line_1390:;
    H_arr[(int)(T)] = H_arr[(int)(T)]+Q;
    gosub_stack[gosub_sp++] = 9; goto line_1810; line_ret_9:;
...
line_1440:;
    R = floor(((X_arr[(int)(T)]-Y_arr[(int)(T)]*P+25)*((double)rand() / (double)RAND_MAX)-15)/K);
...
line_1700:;
    if (Y_arr[(int)(T)]*P<X_arr[(int)(T)]) { goto line_1740; }
...
line_1742:;
    gosub_stack[gosub_sp++] = 10; goto line_1850; line_ret_10:;
    if (Y_arr[(int)(T)]*P<X_arr[(int)(T)]+10) { goto line_1745; }
...
line_1750:;
    T = T_arr[(int)(T)];
    gosub_stack[gosub_sp++] = 11; goto line_1900; line_ret_11:;
    goto line_830;
...
line_1810:;
    printf("\n");
    printf("%s", "TEAM 1 SCORE IS"); printf("%g ", (double)(H_arr[(int)(1)])); printf("\n");
    /* BASIC: 1820 PRINT "TEAM 2 SCORE IS";H(2): PRINT */
line_1820:;
    printf("%s", "TEAM 2 SCORE IS"); printf("%g ", (double)(H_arr[(int)(2)])); printf("\n");
    printf("\n");
    /* BASIC: 1825 IF H(T)<E THEN 1830 */
line_1825:;
    if (H_arr[(int)(T)]<E) { goto line_1830; }
...
line_1860:;
    X = 1; for_loop_X_1860: if (((1) >= 0 && X > (72)) || ((1) < 0 && X < (72))) goto end_for_X_1860;
    printf("%s", "+");
    X += (1); goto for_loop_X_1860; end_for_X_1860:;
    printf("\n");
    /* BASIC: 1870 RETURN */
line_1870:;
    switch (gosub_stack[--gosub_sp]) {     case 1: goto line_ret_1;     case 2: goto line_ret_2;     case 3: goto line_ret_3;     case 4: goto line_ret_4;     case 5: goto line_ret_5;     case 6: goto line_ret_6;     case 7: goto line_ret_7;     case 8: goto line_ret_8;     case 9: goto line_ret_9;     case 10: goto line_ret_10;     case 11: goto line_ret_11;     default: fprintf(stderr, "GOSUB stack error\n"); exit(1); }
...
line_1900:;
    { int _t; for(_t=0; _t<D_arr[(int)(T)]+5+P/2; _t++) printf(" "); } printf("%s", M_str_arr[(int)(T)]); printf("\n");
