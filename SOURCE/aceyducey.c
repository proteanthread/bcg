...
int main(int argc, char **argv) {
    ...
    double DEALER, FACE, DEPENDING, ARE, M, FUN, NOW, MORRISTOWN, GAME, VALUE, BET, B, C, IS, BLEW, NEW, DOLLARS, K, CHICKEN, ONLY, MUCH, TWO, FRIEND, WHETHER, SORRY, ACEY, WILL, COMPUTING, CREATIVE, THE, JERSEY, PLAYED, WIN, MY, DEALS, COMPUTER, MANNER, QUEEN, YOU, TRY, ON, LOSE, OPTION, CARDS, A, HERE, WHAT, WAD, HOPE, FOLLOWING, NO, BETWEEN, UP, BUT, KING, JACK, WANT, DO, FIRST, DUCEY, AGAIN, YES, CARD, O, TOO, N, ACE, HAVE, YOUR, HAD, Q, IN, FEEL, AN;
    char _input_buf[256];
...
line_1020:
    printf("%s", "TRY AGAIN (YES OR NO)"); fgets(A_str, sizeof(A_str), stdin); A_str[strcspn(A_str, "\n")] = 0;
