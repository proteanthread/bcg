...
int main(int argc, char **argv) {
    ...
    double MINIMUM, SOLID, USE, SHALL, ENTER, READ, P, TABLE, NEW, TYPE, INSTRUCTIONS, LAYOUT, JERSEY, THE, ON, YORK, LEFT, EXAMPLE, D, ALREADY, WHEN, IT, STRAIGHT, PAY, BETS, T, BANK, IN, BETTING, NUMBER, BY, MORRISTOWN, ANY, SOON, DATA, OFF, UNDER, SPENT, MONEY, BACK, JANUARY, COMMA, NUMBERS, SECOND, WANT, TOTALS, RESTORE, BROKE, RED, YOUR, I, THANKS, DOLLAR, SPINNING, Y, DUM, M, ME, BET, IS, OWN, DOLLARS, OF, Z, LL, S, ORDER, CREATIVE, ROULETTE, WIN, WHEEL, HOUSE, COMPUTER, SIGNIFY, EACH, YOU, NOTE, LOSE, X, AS, NO, OOPS, ONCE, MEMORY, LAST, BUY, COME, THEIR, TYPES, I1, ARE, WHOM, THIRD, AMOUNT, EXCEPT, C, HOW, MAKE, CURRENT, SEPARATED, COMPUTING, JUST, ODD, E, WELCOME, COLUMN, BLACK, MANY, EVEN, DATE, GOLD, DO, FIRST, THAT, R, AGAIN, MAXIMUM, ASK, MADE, N, COUNT, THIS, CHECK, THESE;
...
line_40:
    ...
    /* BASIC: 50 INPUT D$,E$ */
line_50:
    printf("? "); fgets(D$,E_str, sizeof(D$,E_str), stdin); D$,E_str[strcspn(D$,E_str, "\n")] = 0;
...
line_1560:
    ...
    /* BASIC: 1570 REM  DON'T NEED TO DIMENSION STRINGS */
line_1570:
...
line_1600:
    I = 1; for_loop_I: if ((1 >= 0 && I > 38) || (1 < 0 && I < 38)) goto end_for_I;
    X(I) = 0;
...
line_1660:
    I = 1; for_loop_I: if ((1 >= 0 && I > 50) || (1 < 0 && I < 50)) goto end_for_I;
    A(I) = 0;
    I += 1; goto for_loop_I; end_for_I:;
    // REM  MAT A=ZER
    /* BASIC: 1670 FOR C=1 TO Y */
line_1670:
    C = 1; for_loop_C: if ((1 >= 0 && C > Y) || (1 < 0 && C < Y)) goto end_for_C;
    /* BASIC: 1680 PRINT "NUMBER";C; */
line_1680:
    printf("%s", "NUMBER"); printf("%g ", (double)(C));
    /* BASIC: 1690 INPUT X,Z */
line_1690:
    printf("? "); if (fgets(_input_buf, sizeof(_input_buf), stdin)) sscanf(_input_buf, "%lf", &X,Z);
    /* BASIC: 1700 B(C)=Z */
line_1700:
    B(C) = Z;
    /* BASIC: 1710 T(C)=X */
...
line_1930:
    I1 = 1; for_loop_I1: if ((1 >= 0 && I1 > 18) || (1 < 0 && I1 < 18)) goto end_for_I1;
    /* BASIC: 1940 READ R */
line_1940:
    /* UNTRANSLATED: READ R */
...
line_1960:
    ...
    /* BASIC: 1970 A$="BLACK" */
line_1970:
    strncpy(A_str, ""BLACK"", sizeof(A_str)); /* String assign approx */
...
line_1990:
    ...
    /* BASIC: 2000 A$="RED" */
line_2000:
    strncpy(A_str, ""RED"", sizeof(A_str)); /* String assign approx */
...
line_2040:
    if (T(C)<37) goto line_2710;
    /* BASIC: 2050 ON T(C)-36 GOTO 2090,2190,2220,2250,2300,2350,2400,2470,2500 */
line_2050:
    /* UNTRANSLATED: ON T(C)-36 GOTO 2090,2190,2220,2250,2300,2350,2400,2470,2500 */
    /* BASIC: 2060 ON T(C)-45 GOTO 2530,2560,2630 */
line_2060:
    /* UNTRANSLATED: ON T(C)-45 GOTO 2530,2560,2630 */
...
line_2110:
    printf("%s", "YOU LOSE"); printf("%g ", (double)(B(C))); printf("%s", "DOLLARS ON BET"); printf("%g ", (double)(C)); printf("\n");
    /* BASIC: 2120 D=D+B(C) */
line_2120:
    D = D+B(C);
    /* BASIC: 2130 P=P-B(C) */
...
line_2150:
    printf("%s", "YOU WIN"); printf("%g ", (double)(B(C)*2)); printf("%g ", (double)("DOLLARS ON BET"C)); printf("\n");
...
line_2260:
    I = 1; for_loop_I: if ((3 >= 0 && I > 34) || (3 < 0 && I < 34)) goto end_for_I;
...
line_2310:
    I = 2; for_loop_I: if ((3 >= 0 && I > 35) || (3 < 0 && I < 35)) goto end_for_I;
...
line_2360:
    I = 3; for_loop_I: if ((3 >= 0 && I > 36) || (3 < 0 && I < 36)) goto end_for_I;
...
line_2430:
    printf("%s", "YOU WIN"); printf("%g ", (double)(B(C))); printf("%s", "DOLLARS ON BET"); printf("%g ", (double)(C)); printf("\n");
    /* BASIC: 2440 D=D-B(C) */
line_2440:
    D = D-B(C);
    /* BASIC: 2450 P=P+B(C) */
...
line_2700:
    goto line_2430;
    /* BASIC: 2710 REM--1TO36,0,00(1-36,49,50)35:1 */
line_2710:
    // REM--1TO36,0,00(1-36,49,50)35
    /* UNTRANSLATED: 1 */
    /* BASIC: 2720 IF T(C)<49 THEN 2760 */
line_2720:
    if (T(C)<49) goto line_2760;
    /* BASIC: 2730 IF T(C)=49 AND S=37 THEN 2780 */
line_2730:
    if (T(C)==49 && S==37) goto line_2780;
    /* BASIC: 2740 IF T(C)=50 AND S=38 THEN 2780 */
line_2740:
    if (T(C)==50 && S==38) goto line_2780;
    /* BASIC: 2750 GOTO 2110 */
line_2750:
    goto line_2110;
    /* BASIC: 2760 IF T(C)=S THEN 2780 */
line_2760:
    if (T(C)==S) goto line_2780;
    /* BASIC: 2770 GOTO 2110 */
line_2770:
    goto line_2110;
    /* BASIC: 2780 PRINT "YOU WIN";B(C)*35;"DOLLARS ON BET";C */
line_2780:
    printf("%s", "YOU WIN"); printf("%g ", (double)(B(C)*35)); printf("%s", "DOLLARS ON BET"); printf("%g ", (double)(C)); printf("\n");
...
line_3140:
    { int _t; for(_t=0; _t<40)"----------X-----; _t++) printf(" "); } printf("\n");
    /* BASIC: 3150 PRINT */
line_3150:
    printf("\n");
    /* BASIC: 3160 FOR I=1 TO 62: PRINT "-";: NEXT I */
line_3160:
    I = 1; for_loop_I: if ((1 >= 0 && I > 62) || (1 < 0 && I < 62)) goto end_for_I;
    printf("%s", "-");
    I += 1; goto for_loop_I; end_for_I:;
...
line_3230:
    // REM
    /* BASIC: 3240 REM     THIS ROUTINE RETURNS THE CURRENT DATE IN M$ */
line_3240:
    // REM     THIS ROUTINE RETURNS THE CURRENT DATE IN M$
    /* BASIC: 3250 REM     IF YOU HAVE SYSTEM FUNCTIONS TO HANDLE THIS */
line_3250:
...
line_3290:
    // REM
    /* BASIC: 3300 REM     THE DATE IS RETURNED IN VARIABLE M$ */
line_3300:
    // REM     THE DATE IS RETURNED IN VARIABLE M$
    /* BASIC: 3310 M$=D$+", "+E$ */
line_3310:
    strncpy(M_str, "D$+", "+E$", sizeof(M_str)); /* String assign approx */
    /* BASIC: 3320 RETURN */
line_3320:
    /* TODO: RETURN */
    /* BASIC: 3420 END */
