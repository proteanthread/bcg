...
int main(int argc, char **argv) {
    ...
    double ABS, VIA, PROCEDURE, ENTER, NEW, REPORTED, INSTRUCTIONS, BOARD, MANUAL, FUEL, SQR, JERSEY, THE, TAKEN, UNITS, ON, LICENSE, A, D, WHEN, BUT, IT, CONTROL, DISTANCE, T, DURING, RENEWED, NUMBER, LONGER, OUT, SIMULATION, BY, ABOVE, MORRISTOWN, MOON, FOOT, BLEW, THRUST, ROCKET, SECONDS, PLOT, HERE, BURN, SPACE, U, VELOCITY, V, SECOND, SHUT, LATER, WANT, CONTINUE, SPEED, YOUR, I, APPROPRIATE, SURFACE, UNTIL, DIGBY, H, IS, CONGRATULATIONS, K, FEET, OF, WARD, LUNAR, SORRY, WILL, CREATIVE, CRAFT, CONDOLENCES, COMPUTER, EACH, BEGINNING, YOU, NO, APPEAR, AUTOMATICALLY, LANDING, ANOTHER, GIVEN, RUN, AFTER, REPORT, CONTACT, G, APOLLO, GOOD, TOUCHDOWN, UNIT, SLOW, V1, ARE, BE, B, C, WISH, PERFECT, ENGINE, HEIGHT, SEC, COMPUTING, DESCENT, MISSION, AT, L, GOVERN, DOWN, F, DO, THAT, YES, PER, O, OVER, MAXIMUM, SPOT, HAVE, RULES, SENT, KIN;
    char _input_buf[256];
...
line_850:
    printf("%s", "ANOTHER MISSION"); fgets(A_str, sizeof(A_str), stdin); A_str[strcspn(A_str, "\n")] = 0;
    /* BASIC: 860 IF A$="YES" THEN 390 */
line_860:
    if (A$=="YES") goto line_390;
