...
int main(int argc, char **argv) {
    ...
    double NOW, BUGS, TEST, JUDD, GREATS, NEW, TYPE, HA, FUDD, LITERATURE, WHOSE, RE, JERSEY, THE, TRIXIA, REAL, SCHOOL, ON, MARK, A, BUT, WOW, IT, KNOW, LITTLE, IN, KNOWLEDGE, CHILDREN, NIXON, MORRISTOWN, CAT, ATE, SLEEPING, CINDERELLA, QUIZ, CHOICE, CICERO, SWIFT, WAS, OH, LUCK, TIME, BACK, SUPER, HERE, WHAT, BAD, DEFINITELY, REALLY, MIGHT, TOO, GARDEN, YOUR, OS, NURSERY, CARROTS, FROM, VERY, MORE, GIANT, IS, POISON, WIZARD, OF, FRIEND, UGH, SORRY, S, WILL, GUIPETTO, MULTIPLE, CREATIVE, READING, MY, HIS, YOU, PINOCCHIO, STROMBOLI, SPEND, NAME, KING, ANOTHER, AFTER, QUESTION, STEAL, MEMORY, GOOD, ELMER, DOG, COME, WENDY, BEAUTY, BE, CHINESE, FIGARO, YEA, NAMED, BUNNY, SNOW, CENTURY, COMPUTING, BOOKS, CLEM, FAIR, WHITE, DID, R, THAT, TOTO, MR, DOROTHY, WHO, APPLE, MAIDEN, THIS, TIGGER, PRETTY;
    char _input_buf[256];
