...
int main(int argc, char **argv) {
    ...
    double NUMBER, LINE, GUESSES, VERY, M, BY, POSITION, MORRISTOWN, GAME, C, IS, NEW, TYPE, CORRESPONDING, ELEVEN, OTHERS, OF, RESET, Z, TYPING, TWO, START, ONLY, OBJECT, S, GUESSED, WILL, MIDDLE, COMPUTING, CREATIVE, JERSEY, THE, SOME, TIME, SIN, TRY, YOU, ON, HARDER, PUZZLE, X, LEFT, A, FLIPFLOP, HERE, STARTING, ILLEGAL, CHANGE, LETTER, TAN, NUMBERS, IT, ONE, ANOTHER, WANT, AGAIN, DO, ENTRY, R, COS, O, OVER, N, ALL, GOOD, THIS, TOOK, Q, IN, ZERO;
