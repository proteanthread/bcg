...
line_80:;
    printf("%s", "CHOOSE YOUR OPPONENT"); if (fgets(_input_buf, sizeof(_input_buf), stdin)) sscanf(_input_buf, "%255s", O_str);
...
line_491:;
    if (S_arr[(int)(1)]!=S_arr[(int)(0)]) { goto line_510; }
...
line_494:;
    printf("%s", "        DARTMOUTH:"); printf("%g ", (double)(S_arr[(int)(1)])); printf("%s", "  "); printf("%s", O_str); printf("%s", ":"); printf("%g ", (double)(S_arr[(int)(0)])); printf("\n");
    /* BASIC: 495 PRINT */
line_495:;
    printf("\n");
...
line_515:;
    printf("%s", "FINAL SCORE: DARTMOUTH:"); printf("%g ", (double)(S_arr[(int)(1)])); printf("%s", "  "); printf("%s", O_str); printf("%s", ":"); printf("%g ", (double)(S_arr[(int)(0)])); printf("\n");
    /* BASIC: 520 S TO P */
line_520:;
    /* UNTRANSLATED: S TO P */
    /* BASIC: 600 PRINT */
...
line_1000:;
    switch ((int)(Z)) {     case 1: goto line_1040;     case 2: goto line_1040; }
...
line_1075:;
    gosub_stack[gosub_sp++] = 2; goto line_7000; line_ret_2:;
...
line_1260:;
    gosub_stack[gosub_sp++] = 4; goto line_4000; line_ret_4:;
...
line_1304:;
    gosub_stack[gosub_sp++] = 5; goto line_600; line_ret_5:;
...
line_1345:;
    gosub_stack[gosub_sp++] = 6; goto line_7000; line_ret_6:;
...
line_1520:;
    gosub_stack[gosub_sp++] = 7; goto line_4000; line_ret_7:;
...
line_3015:;
    gosub_stack[gosub_sp++] = 8; goto line_600; line_ret_8:;
    /* BASIC: 3018 PRINT */
line_3018:;
    printf("\n");
...
line_3220:;
    gosub_stack[gosub_sp++] = 10; goto line_4000; line_ret_10:;
    /* BASIC: 3230 GOTO 425 */
line_3230:;
    goto line_425;
...
line_3540:;
    gosub_stack[gosub_sp++] = 11; goto line_6000; line_ret_11:;
    /* BASIC: 3550 GOTO 425 */
line_3550:;
    goto line_425;
...
line_4030:;
    S_arr[(int)(1-P)] = S_arr[(int)(1-P)]+2;
    /* BASIC: 4040 GOSUB 6010 */
line_4040:;
    gosub_stack[gosub_sp++] = 12; goto line_6010; line_ret_12:;
    /* BASIC: 4041 RETURN */
line_4041:;
    switch (gosub_stack[--gosub_sp]) {     case 1: goto line_ret_1;     case 2: goto line_ret_2;     case 3: goto line_ret_3;     case 4: goto line_ret_4;     case 5: goto line_ret_5;     case 6: goto line_ret_6;     case 7: goto line_ret_7;     case 8: goto line_ret_8;     case 9: goto line_ret_9;     case 10: goto line_ret_10;     case 11: goto line_ret_11;     case 12: goto line_ret_12;     case 13: goto line_ret_13;     case 14: goto line_ret_14;     case 15: goto line_ret_15;     default: fprintf(stderr, "GOSUB stack error\n"); exit(1); }
...
line_5015:;
    gosub_stack[gosub_sp++] = 13; goto line_7000; line_ret_13:;
...
line_5130:;
    gosub_stack[gosub_sp++] = 14; goto line_6000; line_ret_14:;
    /* BASIC: 5140 GOTO 425 */
line_5140:;
    goto line_425;
    /* BASIC: 6000 S(0)=S(0)+2 */
line_6000:;
    S_arr[(int)(0)] = S_arr[(int)(0)]+2;
    /* BASIC: 6010 PRINT "SCORE: ";S(1);"TO";S(0) */
line_6010:;
    printf("%s", "SCORE: "); printf("%g ", (double)(S_arr[(int)(1)])); printf("%s", "TO"); printf("%g ", (double)(S_arr[(int)(0)])); printf("\n");
    /* BASIC: 6020 RETURN */
line_6020:;
    switch (gosub_stack[--gosub_sp]) {     case 1: goto line_ret_1;     case 2: goto line_ret_2;     case 3: goto line_ret_3;     case 4: goto line_ret_4;     case 5: goto line_ret_5;     case 6: goto line_ret_6;     case 7: goto line_ret_7;     case 8: goto line_ret_8;     case 9: goto line_ret_9;     case 10: goto line_ret_10;     case 11: goto line_ret_11;     case 12: goto line_ret_12;     case 13: goto line_ret_13;     case 14: goto line_ret_14;     case 15: goto line_ret_15;     default: fprintf(stderr, "GOSUB stack error\n"); exit(1); }
    /* BASIC: 7000 S(1)=S(1)+2 */
line_7000:;
    S_arr[(int)(1)] = S_arr[(int)(1)]+2;
    /* BASIC: 7010 GOSUB 6010 */
line_7010:;
    gosub_stack[gosub_sp++] = 15; goto line_6010; line_ret_15:;
    /* BASIC: 7020 RETURN */
line_7020:;
    switch (gosub_stack[--gosub_sp]) {     case 1: goto line_ret_1;     case 2: goto line_ret_2;     case 3: goto line_ret_3;     case 4: goto line_ret_4;     case 5: goto line_ret_5;     case 6: goto line_ret_6;     case 7: goto line_ret_7;     case 8: goto line_ret_8;     case 9: goto line_ret_9;     case 10: goto line_ret_10;     case 11: goto line_ret_11;     case 12: goto line_ret_12;     case 13: goto line_ret_13;     case 14: goto line_ret_14;     case 15: goto line_ret_15;     default: fprintf(stderr, "GOSUB stack error\n"); exit(1); }
...
line_8010:;
    printf("%s", "SCORE: DARTMOUTH:"); printf("%g ", (double)(S_arr[(int)(1)])); printf("%s", "  "); printf("%s", O_str); printf("%s", ":"); printf("%g ", (double)(S_arr[(int)(0)])); printf("\n");
    /* BASIC: 8015 PRINT */
line_8015:;
    printf("\n");
    /* BASIC: 8016 PRINT */
