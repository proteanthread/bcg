...
int main(int argc, char **argv) {
    ...
    double LOSERS, NUMBER, OUT, ARE, THROW, SEE, M, NOW, MORRISTOWN, ME, AMOUNT, IS, WAGER, POINT, H, NEW, CONGRATULATIONS, DOLLARS, ODDS, OF, Z, DICE, UNDER, CRAPS, CAME, EYES, S, WILL, COMPUTING, CREATIVE, JERSEY, THE, MONEY, WIN, PLAY, AHEAD, E, YOU, LOSE, X, CONGRATS, A, EVEN, POINTS, AT, BAD, NO, F, HOLE, PICK, WINNER, WANT, AGAIN, R, ROLL, NATURAL, PAYS, O, AMATEUR, LET, T, TOO, WINNERS, YOUR, I, SNAKE, Q, IN, AN, COME;
    char _input_buf[256];
...
line_180:
    printf("%g ", (double)(X "- NATURAL....A WINNER!!!!")); printf("\n");
    /* BASIC: 185 PRINT X"PAYS EVEN MONEY, YOU WIN"F"DOLLARS" */
line_185:
    printf("%g ", (double)(X"PAYS EVEN MONEY, YOU WIN"F"DOLLARS")); printf("\n");
    /* BASIC: 190 GOTO 210 */
line_190:
    goto line_210;
    /* BASIC: 195 PRINT X"- SNAKE EYES....YOU LOSE." */
line_195:
    printf("%g ", (double)(X"- SNAKE EYES....YOU LOSE.")); printf("\n");
    /* BASIC: 196 PRINT "YOU LOSE"F "DOLLARS." */
line_196:
    printf("%s", "YOU LOSE"F "DOLLARS."); printf("\n");
    /* BASIC: 197 LET F=0-F */
line_197:
...
line_200:
    printf("%g ", (double)(X " - CRAPS...YOU LOSE.")); printf("\n");
...
line_220:
    printf("%g ", (double)(X "IS THE POINT. I WILL ROLL AGAIN")); printf("\n");
...
line_270:
    printf("%g ", (double)(O " - NO POINT. I WILL ROLL AGAIN")); printf("\n");
    /* BASIC: 280 GOTO 230 */
line_280:
    goto line_230;
    /* BASIC: 290 PRINT O "- CRAPS. YOU LOSE." */
line_290:
    printf("%g ", (double)(O "- CRAPS. YOU LOSE.")); printf("\n");
    /* BASIC: 291 PRINT "YOU LOSE $"F */
line_291:
    printf("%g ", (double)("YOU LOSE $"F)); printf("\n");
    /* BASIC: 292 F=0-F */
line_292:
    F = 0-F;
    /* BASIC: 293 GOTO 210 */
...
line_310:
    printf("%g ", (double)(X"- A WINNER.........CONGRATS!!!!!!!!")); printf("\n");
    /* BASIC: 311 PRINT X "AT 2 TO 1 ODDS PAYS YOU...LET ME SEE..."2*F"DOLLARS" */
line_311:
    printf("%g ", (double)(X "AT 2 TO 1 ODDS PAYS YOU...LET ME SEE..."2*F"DOLLARS")); printf("\n");
    /* BASIC: 312 LET F=2*F */
line_312:
