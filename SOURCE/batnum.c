...
int main(int argc, char **argv) {
    ...
    double USE, OBJECTS, WINNING, ENTER, P, GAME, TOLD, NEW, AVOID, REENTER, THE, JERSEY, LEAVES, DON, STARTS, A, FORFEIT, LOSES, IT, PROGRAM, T, IN, NUMBER, PLAYING, BY, MORRISTOWN, TAKE, START, HOWEVER, CONDITIONS, LUCK, OPTION, ILLEGAL, NUMBERS, YOUR, I, BATNUM, M, W, IS, CONGRATULATIONS, OF, OBJECT, S, NEGATIVE, CREATIVE, WIN, COMPUTER, BEGINNING, YOU, ADVANCE, LOSE, WINS, AS, WITH, OTHER, TAKING, MIN, BATTLE, SIZE, LAST, OPPONENT, SPECIFY, AN, TOUGH, MAX, B, C, MOVE, ALTERNATELY, PILE, ASSUMED, CAN, COMPUTING, SOME, WHERE, TAKES, ALSO, FIRST, N, DEFINED, THIS, Q, ZERO;
    char _input_buf[256];
...
line_430:
    printf("%s", "ENTER MIN AND MAX "); if (fgets(_input_buf, sizeof(_input_buf), stdin)) sscanf(_input_buf, "%lf", &A,B);
