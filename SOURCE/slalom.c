...
int main(int argc, char **argv) {
    ...
    double USE, GOING, READ, CHEAT, P, GO, CHR, NEW, TYPE, INSTRUCTIONS, OK, RE, THE, JERSEY, GATES, TAKEN, SKIP, WINTER, SKIER, ON, A, HOPE, UP, WHEN, IT, WON, T, LITTLE, O1, OUT, MORRISTOWN, OFFICIAL, DATA, OPTIONS, INS, KEEP, OFF, FLAG, WIPED, COURSE, LUCK, SECONDS, APPROXIMATE, TRY, BACK, NAXIMUM, COUNTS, OPTION, HERE, ILLEGAL, WHAT, CLOSE, V, LOT, MEDALS, WANT, OLYMPIC, SNAGGED, BRONZE, COMMAND, SPEED, LET, S1, TOOK, THANKS, MEDAL, REALISTIC, STARTER, M, AMERICAN, RACE, GIANT, H, IS, OF, ONLY, BEST, S, SAME, CREATIVE, COMPUTER, WENT, CAUGHT, PLEASE, BEGINNING, YOU, COMES, AS, NO, STR, ASKS, ONE, RUN, GATE, G, GOOD, SLALOM, AN, TEAM, ARE, BE, SEE, SPEEDS, MAX, B, HOW, LONG, SILVER, TEENSY, YOURSELF, COMPUTING, BOUNDS, VE, MANY, PLACE, DOES, DOWN, WORST, GOLD, RETRY, AGAIN, DO, YES, O, OVER, MAXIMUM, MADE, RATE, LIMIT, HAVE, THIS, Q, CHECK, THESE;
    char _input_buf[256];
...
line_530:
    O = 1; for_loop_O: if ((1 >= 0 && O > V) || (1 < 0 && O < V)) goto end_for_O;
    /* BASIC: 540    READ Q */
line_540:
    /* UNTRANSLATED: READ Q */
    /* BASIC: 550    PRINT */
...
line_555:
    printf("%s", "HERE COMES GATE #"); printf("%g ", (double)(STR$(O))); printf("%s", ":"); printf("\n");
...
line_770:
    if (B$=="NO") goto line_1740;
    /* BASIC: 780 IF B$="YES" THEN 480 */
line_780:
    if (B$=="YES") goto line_480;
...
line_990:
    /* UNTRANSLATED: ON O1 GOTO 1130,1010,1170,1080,1190,1100,1150,1210 */
    /* BASIC: 1000 STOP */
line_1000:
    exit(0);
...
line_1445:
    printf("%s", "TYPE "); printf("%g ", (double)(CHR$(34))); printf("%s", "INS"); printf("%g ", (double)(CHR$(34))); printf("%s", " FOR INSTRUCTIONS"); printf("\n");
    /* BASIC: 1450 PRINT "TYPE ";CHR$(34);"MAX";CHR$(34);" FOR APPROXIMATE MAXIMUM SPEEDS" */
line_1450:
    printf("%s", "TYPE "); printf("%g ", (double)(CHR$(34))); printf("%s", "MAX"); printf("%g ", (double)(CHR$(34))); printf("%s", " FOR APPROXIMATE MAXIMUM SPEEDS"); printf("\n");
    /* BASIC: 1460 PRINT "TYPE ";CHR$(34);"RUN";CHR$(34);" FOR THE BEGINNING OF THE RACE" */
line_1460:
    printf("%s", "TYPE "); printf("%g ", (double)(CHR$(34))); printf("%s", "RUN"); printf("%g ", (double)(CHR$(34))); printf("%s", " FOR THE BEGINNING OF THE RACE"); printf("\n");
...
line_1500:
    if (A$=="INS") goto line_820;
    /* BASIC: 1510 IF A$="MAX" THEN 1550 */
line_1510:
    if (A$=="MAX") goto line_1550;
    /* BASIC: 1520 IF A$="RUN" THEN 410 */
line_1520:
    if (A$=="RUN") goto line_410;
    /* BASIC: 1530 PRINT CHR$(34);A$;CHR$(34);" IS AN ILLEGAL COMMAND--RETRY"; */
line_1530:
    printf("%g ", (double)(CHR$(34))); printf("%s", A_str); printf("%g ", (double)(CHR$(34))); printf("%s", " IS AN ILLEGAL COMMAND--RETRY");
...
line_1580:
    B = 1; for_loop_B: if ((1 >= 0 && B > V) || (1 < 0 && B < V)) goto end_for_B;
    /* BASIC: 1590    READ Q */
line_1590:
    /* UNTRANSLATED: READ Q */
...
line_1750:
    if (G(1)<1) goto line_1770;
    /* BASIC: 1760 PRINT "GOLD MEDALS:";G(1) */
line_1760:
    printf("%s", "GOLD MEDALS:"); printf("%g ", (double)(G(1))); printf("\n");
    /* BASIC: 1770 IF S(1)<1 THEN 1790 */
line_1770:
    if (S(1)<1) goto line_1790;
    /* BASIC: 1780 PRINT "SILVER MEDALS:";S(1) */
line_1780:
    printf("%s", "SILVER MEDALS:"); printf("%g ", (double)(S(1))); printf("\n");
    /* BASIC: 1790 IF B(1)<1 THEN 1830 */
line_1790:
    if (B(1)<1) goto line_1830;
    /* BASIC: 1800 PRINT "BRONZE MEDALS:";B(1) */
line_1800:
    printf("%s", "BRONZE MEDALS:"); printf("%g ", (double)(B(1))); printf("\n");
