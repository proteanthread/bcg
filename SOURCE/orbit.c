...
int main(int argc, char **argv) {
    ...
    double BYE, ABS, DETONATE, AROUND, USING, NEW, FORGET, XXXXXXXXXXXXX, SO, BELOW, EXPLODED, GRAVITY, ALTITUDE, SPECIAL, SQR, THEY, JERSEY, THE, SUFFICIENT, XXXXXXXXXXXXXXX, COUNTING, DON, UNITS, WITHIN, ON, PLIGHT, A, SUCCESFULLY, FEDERATION, D, BUT, UP, IT, A1, CIRCLING, DISTANCE, COS, T, FAR, IN, OUT, UNABLE, ABOVE, MORRISTOWN, BOMB, CIRCLE, DESTROY, PLANET, INSTRUMENT, BUILT, CENTER, LUCK, THEM, TRY, ORBIT, WHAT, ORBITAL, BETWEEN, VELOCITY, UNFORTUNATELY, YOUR, EXPLOSION, HAS, FROM, POLAR, UNTIL, WITHOUT, H, IS, DIAGRAM, HOUR, DEVICE, MILES, OF, EVERY, PHOTON, ENOUGH, ITS, ORDER, S, WILL, ESCAPE, CREATIVE, EACH, XXXXXXXXXXXXXXXXX, BEGINNING, YOU, X, ENEMY, SHIP, WITH, ONE, ANOTHER, CONSTANT, ONCE, GIVEN, AFTER, NEAR, SEVEN, ASKED, COUNTERCLOCKWISE, GOOD, ANGLE, AN, THEIR, ARE, BE, SEE, XXXXXXXXXXX, GONE, HOW, C, POWER, WISH, INTO, TELL, FIRE, PRESENT, XXXXXXXXXXXXXXXXXXX, CAN, WHICH, COMPUTING, HELP, VISUALIZE, MISSION, GIVE, COMPLETED, SEND, AT, HOURS, DO, CLOAKING, THAT, R, YES, O, ROMULANS, RATE, D1, SOMEWHERE, HAVE, ROMULAN, THIS, ALLOWED;
    char _input_buf[256];
