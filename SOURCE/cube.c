...
int main(int argc, char **argv) {
    ...
    double NOW, P, GAME, J, NEW, INPUTING, INSTRUCTIONS, TRIED, JERSEY, THE, ON, FOOL, A, EXAMPLE, CHANGE, D, MINES, WHEN, IT, ZERO, GOODBYE, A1, IN, NUMBER, Q, PLAYING, BY, MORRISTOWN, ANY, Z1, START, LOCATIONS, DIRECTION, MONEY, LUCK, PLAY, Z2, DECISION, TRY, STARTED, DETAIL, ILLEGAL, THREE, SPACE, NUMBERS, WANT, DESIGNATED, RANDOM, LET, ALL, QUESTIONS, YOUR, I, FROM, Y, M, ME, BET, W, H, IS, LOCATION, CONGRATULATIONS, DOLLARS, K, ROUND, B7, OF, ONLY, Z, MUCH, OBJECT, SAME, S, WILL, CREATIVE, COMPUTER, EACH, YOU, LOSE, X, AS, NO, AUTOMATICALLY, WITH, ONE, PICK, STATING, OTHER, G, GOOD, AN, MAY, TOUGH, BE, ARE, SEE, ANSWERED, ACCOUNT, B, HOW, AMOUNT, C, MAKE, WAGER, BANG, MOVE, AGAINST, CAN, TWO, LAND, SUCH, WHICH, COMPUTING, GET, HIT, E, SIDE, FIELD, AT, L, TAKES, F, CUBE, DO, BUST, THAT, YES, R, AGAIN, O, N, HAVE, THIS, PLANT, MINOR, THESE;
    char _input_buf[256];
...
line_930:
    printf("? "); if (fgets(_input_buf, sizeof(_input_buf), stdin)) sscanf(_input_buf, "%lf", &P,Q,R);
