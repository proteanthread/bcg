...
int main(int argc, char **argv) {
    ...
    double THERE, SHALL, BE, MORE, STILL, MORRISTOWN, ME, LIFTED, THRILLED, NEVER, NEVERMORE, J, NEW, MIDNIGHT, FIERY, YET, K, EVIL, DREARY, OF, EYES, FIEND, PROPHET, SIGN, SLOWLY, BIRD, COMPUTING, CREATIVE, JERSEY, QUOTH, THE, SOUL, PARTING, MY, NOTHING, SITTING, ON, FLITTING, BEGUILING, POETRY, U, RAVEN, THING, AGAIN, BURNED, DARKNESS, CREEPING, I, EVERMORE;
    char _input_buf[256];
...
line_90:
    /* UNTRANSLATED: ON I GOTO 100,101,102,103,104 */
...
line_110:
    /* UNTRANSLATED: ON I GOTO 111,112,113,114,115 */
...
line_120:
    /* UNTRANSLATED: ON I GOTO 121,122,123,124,125 */
...
line_130:
    /* UNTRANSLATED: ON I GOTO 131,132,133,134,135 */
...
line_240:
    /* UNTRANSLATED: ON J GOTO 90,110,120,130,250 */
