...
int main(int argc, char **argv) {
    ...
    double TOSS, ABS, INCORRECT, QUARTERBACK, READ, GAIN, P, GAME, GO, LOSS, NEW, TYPE, GOAL, INTERCEPTED, ANSWER, PASSER, JERSEY, THE, FNF, ON, A, QUICK, PLAYS, D, WON, OFFSIDES, BLOCKED, T, FNG, R1, FOLLOWS, BATTED, NUMBER, DEF, ELECT, PENALTY, MORRISTOWN, P3, DATA, OFF, YARD, DARTMOUTH, PLAY, BACK, ILLEGAL, RECIEVE, FINAL, LET, DELAYED, ACCEPTED, RECEIVE, YOUR, I, TRICKY, FUMBLE, LINE, FROM, Y, CALL, FTBALL, IS, KICKOFF, YARDS, JUNK, KICK, OF, Z, SCORE, RUNBACK, S, ITS, WILL, CREATIVE, ACCEPT, RETYPE, PLEASE, YOU, X, AS, Y1, NO, RUN, AFTER, SAFETY, REFUSED, GOOD, OPPONENT, DOG, TOUCHDOWN, CHOOSE, SHORT, LONG, COMPUTING, SGN, E, BALL, SIDE, TACKLED, PUNT, FIELD, L, PLACE, COMPLETE, PASS, DOWN, F, X1, KICKS, TOUCHBACK, DO, FIRST, R, YES, FOOTBALL, O, INCOMPLETE, SIMPLE, CHAMPIONSHIP, ELECTS, X3, THIS;
    char L_str[1000][256] = {0}; /* Static string array fallback */
    char _input_buf[256];
...
line_270:
    ...
    /* BASIC: 280 INPUT O$(1) */
line_280:
    printf("? "); if (fgets(_input_buf, sizeof(_input_buf), stdin)) sscanf(_input_buf, "%lf", &O$(1));
...
line_400:
    printf("%g ", (double)(O$(P))); printf("%s", " WON THE TOSS"); printf("\n");
...
line_440:
    printf("%g ", (double)(O$(1))); printf("%s", " ELECTS TO RECEIVE."); printf("\n");
    /* BASIC: 450 PRINT */
line_450:
    printf("\n");
    /* BASIC: 460 GOTO 580 */
...
line_500:
    E = 1; for_loop_E: if ((1 >= 0 && E > 2) || (1 < 0 && E < 2)) goto end_for_E;
    /* BASIC: 510 IF A$=L$(E) THEN 550 */
line_510:
    if (A$==L$(E)) goto line_550;
    /* BASIC: 520 NEXT E */
line_520:
...
line_600:
    printf("%g ", (double)(Y)); printf("%g ", (double)(L$(3))); printf("%s", " KICKOFF"); printf("\n");
...
line_651:
    printf("%g ", (double)(Y)); printf("%g ", (double)(L$(3))); printf("%s", " RUNBACK"); printf("\n");
    /* BASIC: 652 GOTO 720 */
line_652:
    goto line_720;
    /* BASIC: 655 PRINT L$(4); */
...
line_700:
    printf("%s", "TOUCHBACK FOR "); printf("%g ", (double)(O$(P))); printf("%s", "."); printf("\n");
...
line_760:
    printf("\n");
    printf("%s", "FIRST DOWN "); printf("%g ", (double)(O$(P))); printf("%s", "***"); printf("\n");
    /* BASIC: 770 PRINT */
line_770:
    printf("\n");
    /* BASIC: 780 PRINT */
...
line_820:
    printf("%g ", (double)(L$(5))); printf("%g ", (double)(O$(0))); printf("%g ", (double)(X)); printf("%g ", (double)(L$(6))); printf("\n");
    /* BASIC: 830 GOTO 850 */
line_830:
    goto line_850;
    /* BASIC: 840 PRINT L$(5);O$(1);100-X;L$(6) */
line_840:
    printf("%g ", (double)(L$(5))); printf("%g ", (double)(O$(1))); printf("%g ", (double)(100-X)); printf("%g ", (double)(L$(6))); printf("\n");
    /* BASIC: 850 RETURN */
line_850:
    /* TODO: RETURN */
...
line_920:
    printf("%s", "FINAL SCORE:  "); printf("%g ", (double)(O$(0))); printf("%s", ": "); printf("%g ", (double)(S(0))); printf("%s", "  "); printf("%g ", (double)(O$(1))); printf("%s", ": "); printf("%g ", (double)(S(1))); printf("\n");
    /* BASIC: 930 STOP */
line_930:
    exit(0);
...
line_1020:
    printf("%g ", (double)(L$(Z+6))); printf("%s", ".  ");
...
line_1050:
    /* UNTRANSLATED: ON Z GOTO 1110,1150,1260,1480,1570,1570,1680 */
...
line_1610:
    printf("%g ", (double)(Y)); printf("%g ", (double)(L$(3))); printf("%s", " PUNT"); printf("\n");
...
line_1650:
    printf("%g ", (double)(Y1)); printf("%g ", (double)(L$(3))); printf("%s", " RUN BACK"); printf("\n");
...
line_2240:
    printf("%g ", (double)(fabs(Y))); printf("%g ", (double)(L$(3)));
    /* BASIC: 2250 PRINT L$(15+SGN(Y)) */
line_2250:
    printf("%g ", (double)(L$(15+SGN(Y)))); printf("\n");
...
line_2500:
    /* UNTRANSLATED: ON 1+E-F*2+P*4 GOTO 2510,2590,2760,2710,2590,2510,2710,2760 */
...
line_2530:
    printf("%g ", (double)(L$(19))); printf("\n");
    /* BASIC: 2540 GOSUB 2800 */
line_2540:
    /* TODO: GOSUB 2800 */
    /* BASIC: 2550 PRINT O$(P);" KICKS OFF FROM ITS 20 YARD LINE." */
line_2550:
    printf("%g ", (double)(O$(P))); printf("%s", " KICKS OFF FROM ITS 20 YARD LINE."); printf("\n");
...
line_2600:
    printf("%g ", (double)(L$(17))); printf("%s", "***"); printf("\n");
...
line_2650:
    printf("%g ", (double)(O$(P))); printf("%s", " KICKS OFF"); printf("\n");
...
line_2700:
    goto line_2640;
    /* BASIC: 2710 REM TOUCHBACK */
line_2710:
    // REM TOUCHBACK
    /* BASIC: 2720 PRINT L$(18) */
line_2720:
    printf("%g ", (double)(L$(18))); printf("\n");
...
line_2770:
    printf("%g ", (double)(L$(17))); printf("%s", "FOR "); printf("%g ", (double)(O$(1-P))); printf("%s", "***"); printf("\n");
...
line_2820:
    printf("%s", "SCORE:  "); printf("%g ", (double)(S(0))); printf("%s", " TO "); printf("%g ", (double)(S(1))); printf("\n");
    /* BASIC: 2830 PRINT */
line_2830:
    printf("\n");
    /* BASIC: 2840 PRINT */
...
line_2880:
    printf("%g ", (double)(O$(P3))); printf("%s", " OFFSIDES -- PENALTY OF 5 YARDS."); printf("\n");
    /* BASIC: 2890 PRINT */
line_2890:
    printf("\n");
    /* BASIC: 2900 PRINT */
...
line_2940:
    if (A$=="NO") goto line_2300;
    /* BASIC: 2950 IF A$="YES" THEN 3110 */
line_2950:
    if (A$=="YES") goto line_3110;
