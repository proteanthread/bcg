...
int main(int argc, char **argv) {
    ...
    double SHOT, ACCOMPLISHED, P2, P, TEST, TOLD, NEW, APPROX, BELOW, JERSEY, THE, ON, LEFT, A, X2, D, RIGHT, UP, IT, SHOTS, A1, BEHIND, DEVIATION, DISTANCE, COS, R1, IN, DEGREES, NUMBER, ACCURATE, ABOVE, MORRISTOWN, SIGHTED, P3, BLEW, TARGET, Z1, SHOOT, AXES, WAS, LUCK, Y2, OFFICER, Z2, SIN, APPROXIMATE, OFFSET, THREE, RANGE, I, EXPLOSION, DIMENSIONAL, FROM, Y, UNTIL, FUNCTIONAL, W, IS, LOCATION, ESTIMATED, COORDINATES, OF, Z, DESTROYED, RADIANS, B1, KILOMETERS, WILL, CREATIVE, YOU, X, Y1, PROCEEED, WEAPONS, GOOD, P1, ANGLE, AXIS, ENTERPRISE, ARE, BE, SEE, POSITION, B, HOW, YOURSELF, COMPUTING, RADIAN, HIT, STARSHIP, MISSION, AT, X1, RECTANGULAR, R, NON, THIS, FRONT, Q;
    char _input_buf[256];
...
line_350:
    /* UNTRANSLATED: ON R GOTO 355,360,365,370,375 */
...
line_405:
    printf("? "); if (fgets(_input_buf, sizeof(_input_buf), stdin)) sscanf(_input_buf, "%lf", &A1,B1,P2);
