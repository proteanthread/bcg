...
int main(int argc, char **argv) {
    ...
    double BRAVO, ABS, BE, M, READ, Y, ABOVE, ACCOMPLISHMENT, MORRISTOWN, NOW, P, GAME, W, H, IS, C, DATA, VERSION, NEW, MOVE, LONG, COMPRESSED, OF, Z, TYPING, BOARD, SCORE, PAPER, SO, PERFECT, RECORD, S, OK, BEGIN, WILL, WHICH, COMPUTING, CREATIVE, JERSEY, THE, PLAY, SAVE, TIME, WHERE, TRY, YOU, X, A, HERE, REFER, ILLEGAL, AS, PEG, USED, NO, F, NUMBERS, ONE, AGAIN, R, YES, O, OVER, MADE, T, LET, RESTORE, PIECE, DURING, HAD, I, THIS, YOUR, Q, PIECES;
...
line_29:
    R = 1; for_loop_R: if ((1 >= 0 && R > 9) || (1 < 0 && R < 9)) goto end_for_R;
    /* BASIC: 30 FOR C=1 TO 9 */
line_30:
    C = 1; for_loop_C: if ((1 >= 0 && C > 9) || (1 < 0 && C < 9)) goto end_for_C;
...
line_75:
    W = 1; for_loop_W: if ((1 >= 0 && W > 33) || (1 < 0 && W < 33)) goto end_for_W;
    /* BASIC: 77 READ M */
line_77:
    /* UNTRANSLATED: READ M */
...
line_150:
    if (B(P)==0) goto line_120;
    /* BASIC: 153 IF B(P)=-7 THEN 120 */
line_153:
    if (B(P)==-7) goto line_120;
...
line_510:
    X = 1; for_loop_X: if ((1 >= 0 && X > 9) || (1 < 0 && X < 9)) goto end_for_X;
    /* BASIC: 520 FOR Y=1 TO 9 */
line_520:
    Y = 1; for_loop_Y: if ((1 >= 0 && Y > 9) || (1 < 0 && Y < 9)) goto end_for_Y;
...
line_1510:
    R = 2; for_loop_R: if ((1 >= 0 && R > 8) || (1 < 0 && R < 8)) goto end_for_R;
    /* BASIC: 1520 FOR C=2 TO 8 */
line_1520:
    C = 2; for_loop_C: if ((1 >= 0 && C > 8) || (1 < 0 && C < 8)) goto end_for_C;
    /* BASIC: 1530 IF T(R,C)<>5 THEN 1580 */
line_1530:
    if (T(R,C)!=5) goto line_1580;
    /* BASIC: 1535 F=F+1 */
line_1535:
    F = F+1;
    /* BASIC: 1540 FOR A=R-1 TO R+1 */
line_1540:
    A = R-1; for_loop_A: if ((1 >= 0 && A > R+1) || (1 < 0 && A < R+1)) goto end_for_A;
    /* BASIC: 1545 T=0 */
line_1545:
    T = 0;
    /* BASIC: 1550 FOR B=C-1 TO C+1 */
line_1550:
    B = C-1; for_loop_B: if ((1 >= 0 && B > C+1) || (1 < 0 && B < C+1)) goto end_for_B;
...
line_1565:
    if (T(A,C)!=0) goto line_1630;
    /* BASIC: 1567 NEXT A */
line_1567:
    A += 1; goto for_loop_A; end_for_A:;
    /* BASIC: 1568 FOR X=C-1 TO C+1 */
line_1568:
    X = C-1; for_loop_X: if ((1 >= 0 && X > C+1) || (1 < 0 && X < C+1)) goto end_for_X;
    /* BASIC: 1569 T=0 */
line_1569:
    T = 0;
    /* BASIC: 1570 FOR Y=R-1 TO R+1 */
line_1570:
    Y = R-1; for_loop_Y: if ((1 >= 0 && Y > R+1) || (1 < 0 && Y < R+1)) goto end_for_Y;
