...
int main(int argc, char **argv) {
    ...
    double DEAL, SMALL, SHOT, SELL, NOW, AIR, THAN, P, HANDS, NEW, J, SO, ANSWER, THE, JERSEY, WATCH, LEFT, TZ, CHANGE, SUCKER, D, POKER, DRAW, IT, DIAMONDS, LIKE, CARD, T, FULL, IN, BETTING, DEF, HAND, FOLD, MORRISTOWN, STRAIG, RICHER, PAIR, TALK, BACK, WHAT, THREE, FLUS, WAD, OUSE, U, V, NUMBERS, WANT, PASTE, CONTINUE, OPEN, LET, ALL, YOUR, I, AM, M, MORE, FNA, ANTE, BET, H, IS, TIE, RAISE, CONGRATULATIONS, K, DIAMOND, OF, Z, DRAWN, LL, ENOUGH, S, WILL, CREATIVE, WIN, MY, EACH, PLEASE, QUEEN, YOU, BUSTED, X, TACK, NO, WOULD, WITH, KING, WE, HIGH, AFTER, TAKING, G, BUSINESS, BUY, SPADES, GOT, THEIR, ARE, SEE, B, HOW, CASINO, C, FNB, LONG, WISH, CAN, TWO, CLUBS, FOUR, COMPUTING, COMPARE, GET, WELCOME, HT, GIVE, MANY, CARDS, BEFORE, HAVEN, PART, DOWN, HEARTS, SCHMAL, JACK, DO, THAT, YES, O, CRUMMY, N, ACE, HAVE, Q, CHECK, PRETTY;
...
line_230:
    Z = 1; for_loop_Z: if ((1 >= 0 && Z > 10) || (1 < 0 && Z < 10)) goto end_for_Z;
...
line_600:
    printf("%g ", (double)("I'LL OPEN WITH $"V)); printf("\n");
    /* BASIC: 610 K=V */
line_610:
    K = V;
...
line_690:
    printf("%g ", (double)("NOW I HAVE $"C"AND YOU HAVE $"S)); printf("\n");
...
line_720:
    if (H$=="YES") goto line_120;
    /* BASIC: 730 IF H$="NO" THEN 4100 */
line_730:
    if (H$=="NO") goto line_4100;
...
line_910:
    Q = 1; for_loop_Q: if ((1 >= 0 && Q > T) || (1 < 0 && Q < T)) goto end_for_Q;
    /* BASIC: 920 INPUT U */
line_920:
...
line_990:
    U = 6; for_loop_U: if ((1 >= 0 && U > 10) || (1 < 0 && U < 10)) goto end_for_U;
    /* BASIC: 1000 IF INT(X/10^(U-6))<>10*INT(X/10^(U-5)) THEN 1020 */
line_1000:
    if (floor(X/10^(U-6))!=10*floor(X/10^(U-5))) goto line_1020;
...
line_1040:
    printf("%s", "I AM TAKING"Z-10-T"CARD");
...
line_1420:
    printf("%g ", (double)("I'LL BET $"V)); printf("\n");
    /* BASIC: 1430 K=V */
line_1430:
    K = V;
...
line_1470:
    ...
    /* BASIC: 1480 J$=H$ */
line_1480:
    strncpy(J_str, "H$", sizeof(J_str)); /* String assign approx */
    /* BASIC: 1490 K$=I$ */
line_1490:
    strncpy(K_str, "I$", sizeof(K_str)); /* String assign approx */
...
line_1580:
    ...
    /* BASIC: 1590 H$=J$ */
line_1590:
    strncpy(H_str, "J$", sizeof(H_str)); /* String assign approx */
    /* BASIC: 1600 I$=K$ */
line_1600:
    strncpy(I_str, "K$", sizeof(I_str)); /* String assign approx */
    /* BASIC: 1610 K=M */
line_1610:
    K = M;
...
line_1680:
    printf("%s", "ALL $"P"REMAINS IN THE POT."); printf("\n");
    /* BASIC: 1690 GOTO 140 */
line_1690:
    goto line_140;
...
line_1740:
    A(Z) = 100*floor(4*((double)rand() / (double)RAND_MAX))+floor(100*((double)rand() / (double)RAND_MAX));
    /* BASIC: 1750 IF INT(A(Z)/100)>3 THEN 1740 */
line_1750:
    if (floor(A(Z)/100)>3) goto line_1740;
    /* BASIC: 1760 IF A(Z)-100*INT(A(Z)/100)>12 THEN 1740 */
line_1760:
    if (A(Z)-100*floor(A(Z)/100)>12) goto line_1740;
    /* BASIC: 1765 IF Z=1 THEN 1840 */
line_1765:
    if (Z==1) goto line_1840;
    /* BASIC: 1770 FOR K=1 TO Z-1 */
line_1770:
    K = 1; for_loop_K: if ((1 >= 0 && K > Z-1) || (1 < 0 && K < Z-1)) goto end_for_K;
    /* BASIC: 1780 IF A(Z)=A(K) THEN 1740 */
line_1780:
    if (A(Z)==A(K)) goto line_1740;
    /* BASIC: 1790 NEXT K */
line_1790:
...
line_1850:
    Z = N; for_loop_Z: if ((1 >= 0 && Z > N+4) || (1 < 0 && Z < N+4)) goto end_for_Z;
    /* BASIC: 1860 PRINT Z"--  "; */
line_1860:
    printf("%g ", (double)(Z"--  "));
...
line_2210:
    if (floor(A(Z)/100)!=floor(A(Z+1)/100)) goto line_2230;
    /* BASIC: 2220 U=U+1 */
line_2220:
    U = U+1;
    /* BASIC: 2230 NEXT Z */
...
line_2260:
    ...
    /* BASIC: 2270 H$="A FLUS" */
line_2270:
    strncpy(H_str, ""A FLUS"", sizeof(H_str)); /* String assign approx */
    /* BASIC: 2280 I$="H IN" */
line_2280:
    strncpy(I_str, ""H IN"", sizeof(I_str)); /* String assign approx */
    /* BASIC: 2290 U=15 */
line_2290:
    U = 15;
    /* BASIC: 2300 RETURN */
...
line_2310:
    Z = N; for_loop_Z: if ((1 >= 0 && Z > N+3) || (1 < 0 && Z < N+3)) goto end_for_Z;
    /* BASIC: 2320 FOR K=Z+1 TO N+4 */
line_2320:
    K = Z+1; for_loop_K: if ((1 >= 0 && K > N+4) || (1 < 0 && K < N+4)) goto end_for_K;
    /* BASIC: 2330 IF B(Z)<=B(K) THEN 2390 */
line_2330:
    if (B(Z)<==B(K)) goto line_2390;
    /* BASIC: 2340 X=A(Z) */
line_2340:
    X = A(Z);
    /* BASIC: 2350 A(Z)=A(K) */
...
line_2520:
    if (B(N+1)+3!=B(N+4)) goto line_2620;
...
line_2540:
    ...
    /* BASIC: 2550 H$="STRAIG" */
line_2550:
    strncpy(H_str, ""STRAIG"", sizeof(H_str)); /* String assign approx */
    /* BASIC: 2560 I$="HT" */
line_2560:
    strncpy(I_str, ""HT"", sizeof(I_str)); /* String assign approx */
    /* BASIC: 2570 X=11111 */
line_2570:
    X = 11111;
    /* BASIC: 2580 D=A(N+4) */
...
line_2630:
    ...
    /* BASIC: 2640 H$="SCHMAL" */
line_2640:
    strncpy(H_str, ""SCHMAL"", sizeof(H_str)); /* String assign approx */
    /* BASIC: 2650 I$="TZ, " */
line_2650:
    strncpy(I_str, ""TZ, "", sizeof(I_str)); /* String assign approx */
    /* BASIC: 2660 U=9 */
line_2660:
    U = 9;
    /* BASIC: 2670 X=11000 */
...
line_2770:
    ...
    /* BASIC: 2780 H$="A PAIR" */
line_2780:
    strncpy(H_str, ""A PAIR"", sizeof(H_str)); /* String assign approx */
    /* BASIC: 2790 I$=" OF " */
line_2790:
    strncpy(I_str, "" OF "", sizeof(I_str)); /* String assign approx */
    /* BASIC: 2800 RETURN */
line_2800:
    /* TODO: RETURN */
...
line_2820:
    if (B(Z)!=B(Z-1)) goto line_2870;
    /* BASIC: 2830 H$="THREE" */
line_2830:
    strncpy(H_str, ""THREE"", sizeof(H_str)); /* String assign approx */
    /* BASIC: 2840 I$=" " */
line_2840:
    strncpy(I_str, "" "", sizeof(I_str)); /* String assign approx */
    /* BASIC: 2850 U=13 */
line_2850:
    U = 13;
    /* BASIC: 2860 RETURN */
line_2860:
    ...
    /* BASIC: 2870 H$="TWO P" */
line_2870:
    strncpy(H_str, ""TWO P"", sizeof(H_str)); /* String assign approx */
    /* BASIC: 2880 I$="AIR, " */
line_2880:
    strncpy(I_str, ""AIR, "", sizeof(I_str)); /* String assign approx */
    /* BASIC: 2890 U=12 */
line_2890:
    U = 12;
    /* BASIC: 2900 RETURN */
...
line_2920:
    ...
    /* BASIC: 2930 H$="FULL H" */
line_2930:
    strncpy(H_str, ""FULL H"", sizeof(H_str)); /* String assign approx */
    /* BASIC: 2940 I$="OUSE, " */
line_2940:
    strncpy(I_str, ""OUSE, "", sizeof(I_str)); /* String assign approx */
    /* BASIC: 2950 RETURN */
line_2950:
    /* TODO: RETURN */
    /* BASIC: 2960 IF B(Z)<>B(Z-1) THEN 3010 */
line_2960:
    if (B(Z)!=B(Z-1)) goto line_3010;
    /* BASIC: 2970 U=17 */
line_2970:
    U = 17;
    /* BASIC: 2980 H$="FOUR" */
line_2980:
    strncpy(H_str, ""FOUR"", sizeof(H_str)); /* String assign approx */
    /* BASIC: 2990 I$=" " */
line_2990:
    strncpy(I_str, "" "", sizeof(I_str)); /* String assign approx */
    /* BASIC: 3000 RETURN */
...
line_3450:
    printf("%g ", (double)("I'LL SEE YOU, && RAISE YOU"V)); printf("\n");
    /* BASIC: 3460 K=G+V */
line_3460:
    K = G+V;
...
line_3770:
    if (H$=="SCHMAL") goto line_3790;
    /* BASIC: 3780 IF H$<>"STRAIG" THEN 3810 */
line_3780:
    if (H$!="STRAIG") goto line_3810;
