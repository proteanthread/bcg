...
int main(int argc, char **argv) {
    ...
    double USE, SENSOR, ITSELF, ENTER, THAN, ZAPPING, DIRECTIONS, LRS, PHASER, GAME, INTEGER, COMPUTE, TYPE, GALAXY, INSTRUCTIONS, SCANS, LIBRARY, ENERGY, DAM, RE, VECTOR, THE, DAMAGED, DIGIT, PREVIOUS, TAKEN, LIST, NAV, XXX, REAL, WARWHIPS, ON, UNITS, WITHIN, A, STARTING, EXAMPLE, KLINGON, ABORTED, FEDERATION, HUNDRESDS, WHEN, CASE, CALCULATOR, CONTROL, LIKE, DISTANCE, STARS, ARRANGEMENT, STARBASES, ARM, FOLLOWS, TORPEDO, INCLUDES, IN, COMMANDS, NEED, TOUR, ALLOWS, TEMPORARILY, NUMBER, FACTOR, OUT, SCREEN, FORM, REFERRED, CALCULATIONS, BY, ANY, DATA, OPTIONS, CONTAINS, PRINTS, DESTROY, GALACTIC, GRID, SUBJECT, SHOWES, COURSE, SYMBOLOGY, CONDITIONS, DIRECTION, SCAN, THEM, DAMMAGE, LEGAL, BACK, OPTION, SUPER, ILLEGAL, EQUIVALENT, HERE, SIX, SEEK, BETWEEN, SRS, THEREFORE, REPAIR, SPACE, TENS, NUMBERS, SIXTEEN, STAR, CRUISERS, SUITABLY, CIRCULAR, CANNOT, CUMULATIVE, COMMAND, RANGE, TOO, ALL, YOUR, I, STATUS, HE, REQUIRE, HAS, FROM, Y, SHOWS, STARDATES, COMANDER, POINT, IS, FLEET, REGION, K, DEVICE, COORDINATES, UNITED, RESULTS, NUMERICAL, OF, KLINGONS, DESTROYED, LL, DISPLAY, PHOTON, RECORD, MENACING, BEGIN, S, SAME, NEGATIVE, WILL, DUTY, THUS, CRUISER, QUADTANT, COMPUTER, EACH, SHE, HIS, YOU, NOTE, PRESENTED, STATE, X, COMES, SHOULD, AS, TREK, TH, NO, USED, NAME, WOULD, WITH, SHIP, MAP, ONE, PHASERS, CODED, CAPTAIN, APPROACH, OTHER, PRINTED, BATTLE, SHOWN, REPORT, SHIELDS, DEFINES, SIZE, MEMORY, AVAILABLE, REGIONS, AN, MAY, SHORT, THEIR, ENTERPRISE, WARP, QUADRANT, VESSEL, BE, ARE, SEE, PLANETS, POSITION, CONDENSED, ASSIGNED, LONG, POWER, INTO, FIRE, PRESENT, LARGE, TOTAL, MAJOR, ENGINE, WHICH, MIDDLE, DEVICES, GET, SECTOR, VALUES, SOME, REFUEL, STARSHIP, HIT, WHERE, MISSION, HALF, SIDE, FURTHER, WAY, GIVES, DIVIDED, AT, FOLLOWING, ALSO, COM, TRAJECTORY, STARBASE, DO, TOR, THAT, SHIELD, N, EITHER, PHA, SOMEWHERE, HAVE, THIS, NAMES, DEPLETE, MISS;
    char _input_buf[256];
...
line_40:
    printf("%s", "DO YOU NEED INSTRUCTIONS (Y/N)"); fgets(K_str, sizeof(K_str), stdin); K_str[strcspn(K_str, "\n")] = 0;
    if (K$=="N") goto line_2000;
    /* BASIC: 44 PRINT */
line_44:
    printf("\n");
