...
/* Global variables */
static double A, A4, B, B5, C, C1, D, F1, G1, H, I, J, K, M6, N5, P, P1, Q, S, T1, U1, U2, V1, V2, V3, V9, W, X, X5;
...
line_10:;
    if (strcmp(basic_LEFT(Z_str,1), "N") == 0) { goto line_47; }
    /* BASIC: 11 IF Z$="AGAIN" THEN 1960 */
line_11:;
    if (strcmp(Z_str, "AGAIN") == 0) { goto line_1960; }
