...
int main(int argc, char **argv) {
    ...
    double CRASH, USE, ABS, SMALL, CRATER, ENTER, AROUND, BASE, NOW, IMPOSSIBLE, INTERVAL, LEM, P, GO, INFORMATION, PERCENT, EXPLORATION, NEW, G5, ASTRONAUTS, NAVIGATION, INSTRUCTIONS, BOARD, ANSWER, ELAPSED, OK, FLOWN, FUEL, SQR, JERSEY, THE, ANGLES, AWAY, IMPACT, UNITS, M1, ON, NEITHER, EXPERIENCED, A, EXAMPLE, HOPE, CHANGE, D, BUT, IT, A1, PROGRAM, DISTANCE, COS, T, WERE, R1, M2, FOLLOWS, COMMANDS, DEGREES, IN, VERTICAL, DEEP, NUMBER, CONTINUUM, OUT, SIMULATION, V0, BY, MORRISTOWN, MOON, ANY, OUTSIDE, PILOT, THRUST, A4, R0, WAS, DISCREPANCIES, DIRECTION, SECONDS, TIME, SIN, TRANQUILITY, EAGLE, TRY, ORBIT, HERE, F1, BAD, HATES, BETWEEN, SPACE, ACCOUNTED, VELOCITY, V, SECOND, R4, LANDED, WANT, R2, VIOLATE, ACCEPTED, TOO, ALL, YOUR, I, OUTPUT, HORIZONTAL, TANGENT, HAS, APPROPRIATE, H1, THERE, FROM, SAFELY, M, SURFACE, BEEN, VALUE, ATTITUDE, IS, H, CONGRATULATIONS, TRAVELING, K, FEET, MILES, OF, Z, B1, ABLE, KILOMETERS, LUNAR, S, WILL, DESCRIBED, NEGATIVE, CREATIVE, EXPECTED, COMPUTER, PLEASE, YOU, ABORT, LOSE, X, ABENDED, CREATED, DAMAGE, AS, H0, NO, MISSED, SHIP, WITH, STATEMENTS, LANDING, SPACECRAFT, NEEDED, PERCENTAGE, QUESTION, MODULE, EXCURSION, CONTACT, SPIN, APOLLO, T1, A2, METRIC, AVAILABLE, ANGLE, UNIT, AN, MAY, MEASU, CERTAIN, ARE, BE, SITE, MAX, B, ACCOUNT, C, TOWARD, A3, POWER, LARGE, M0, TOTAL, G3, ENGLISH, ENGINE, WHICH, SEC, HEIGHT, LOST, COMPUTING, JUST, METERS, PROHIBITED, E, MISSION, GIVE, DIRECTLY, NAVIGATE, BEFORE, CALLED, AT, COMPLETE, DOWN, R3, F, X1, DO, RECOVERY, R, YES, AGAIN, RUNNING, HR, D1, N, T2, HAVE, SYSTEM, THIS, Q, PROCEED, ZERO;
    char _input_buf[256];
...
line_7:
    ...
    /* BASIC: 8 REM LANDING IS SIMILAR TO THAT OF THE APOLLO PROGRAM. */
line_8:
...
line_9:
    ...
    /* BASIC: 10 Z$="GO" */
line_10:
    strncpy(Z_str, ""GO"", sizeof(Z_str)); /* String assign approx */
    /* BASIC: 15 B1=1 */
line_15:
    B1 = 1;
    /* BASIC: 20 M=17.95 */
...
line_170:
    if (Q$=="YES") goto line_190;
    /* BASIC: 175 IF Q$="NO" THEN 205 */
line_175:
    if (Q$=="NO") goto line_205;
...
line_250:
    ...
    /* BASIC: 255 M$="METERS" */
line_255:
    strncpy(M_str, ""METERS"", sizeof(M_str)); /* String assign approx */
    /* BASIC: 260 G3=3.6 */
line_260:
    G3 = 3.6;
    /* BASIC: 265 N$=" KILOMETERS" */
line_265:
    strncpy(N_str, "" KILOMETERS"", sizeof(N_str)); /* String assign approx */
    /* BASIC: 270 G5=1000 */
line_270:
    G5 = 1000;
    /* BASIC: 275 GOTO 305 */
...
line_280:
    ...
    /* BASIC: 285 M$="FEET" */
line_285:
    strncpy(M_str, ""FEET"", sizeof(M_str)); /* String assign approx */
    /* BASIC: 290 G3=.592 */
line_290:
    G3 = .592;
    /* BASIC: 295 N$="N.MILES" */
line_295:
    strncpy(N_str, ""N.MILES"", sizeof(N_str)); /* String assign approx */
    /* BASIC: 300 G5=Z */
line_300:
    G5 = Z;
...
line_585:
    printf("? "); if (fgets(_input_buf, sizeof(_input_buf), stdin)) sscanf(_input_buf, "%lf", &T1,F,P);
    /* BASIC: 590 F=F/100 */
line_590:
    F = F/100;
...
line_1115:
    if (Z$=="YES") goto line_20;
    /* BASIC: 1120 IF Z$="NO" THEN 1130 */
line_1120:
    if (Z$=="NO") goto line_1130;
...
line_1180:
    ...
    /* BASIC: 1185 Q$="NO" */
line_1185:
    strncpy(Q_str, ""NO"", sizeof(Q_str)); /* String assign approx */
    /* BASIC: 1190 IF B1=1 THEN 205 */
line_1190:
    if (B1==1) goto line_205;
    /* BASIC: 1195 Q$="YES" */
line_1195:
    strncpy(Q_str, ""YES"", sizeof(Q_str)); /* String assign approx */
