...
static double A, B, C, D, D1, D2, F, G1, G2, G3, H, I, J, K, L, N, O, P, Q, S1, S2, S9, T, W, X;
...
line_330:;
    if (L_arr[(int)(0)]<1) { goto line_1150; }
    /* BASIC: 340 X=0 */
line_340:;
    X = 0;
    /* BASIC: 350 IF L(0)>5 THEN 1190 */
line_350:;
    if (L_arr[(int)(0)]>5) { goto line_1190; }
...
line_362:;
    ...
    /* BASIC: 380 GOSUB 400 */
line_380:;
    gosub_stack[gosub_sp++] = 1; goto line_400; line_ret_1:;
    /* BASIC: 390 GOTO 620 */
line_390:;
    goto line_620;
    /* BASIC: 400 IF L(X)=1 THEN 480 */
line_400:;
    if (L_arr[(int)(X)]==1) { goto line_480; }
    /* BASIC: 410 IF L(X)=2 THEN 500 */
line_410:;
    if (L_arr[(int)(X)]==2) { goto line_500; }
    /* BASIC: 420 IF L(X)=3 THEN 520 */
line_420:;
    if (L_arr[(int)(X)]==3) { goto line_520; }
    /* BASIC: 430 IF L(X)=4 THEN 540 */
line_430:;
    if (L_arr[(int)(X)]==4) { goto line_540; }
    /* BASIC: 440 IF L(X)=5 THEN 560 */
line_440:;
    if (L_arr[(int)(X)]==5) { goto line_560; }
    /* BASIC: 450 IF L(X)=6 THEN 580 */
line_450:;
    if (L_arr[(int)(X)]==6) { goto line_580; }
...
line_650:;
    if (L_arr[(int)(0)]<=5) { goto line_740; }
...
line_756:;
    if (L_arr[(int)(0)]==2) { goto line_862; }
...
line_840:;
    D2 = floor(sqrt(pow(O, 2)+pow(fabs(D-D1), 2)));
...
line_985:;
    if (L_arr[(int)(0)]==5) { goto line_1280; }
...
line_1190:;
    if (L_arr[(int)(0)]>6) { goto line_1260; }
...
line_1590:;
    read_numeric(&D); read_numeric(&P); read_numeric(&(L_arr[(int)(1)])); read_numeric(&(L_arr[(int)(2)]));
    /* BASIC: 1595 PRINT */
line_1595:;
    printf("\n");
...
line_1640:;
    gosub_stack[gosub_sp++] = 2; goto line_400; line_ret_2:;
...
line_1670:;
    gosub_stack[gosub_sp++] = 3; goto line_400; line_ret_3:;
    /* BASIC: 1680 GOTO 620 */
line_1680:;
    goto line_620;
    /* BASIC: 1690 RETURN */
