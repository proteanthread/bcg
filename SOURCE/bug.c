...
int main(int argc, char **argv) {
    ...
    double NOW, P, GAME, BUGS, NEW, LEGS, INSTRUCTIONS, PICTURES, STAND, FINISHED, JERSEY, THE, HAPPEN, ON, A, HOPE, CHANGE, ALREADY, IT, T, FOLLOWS, IN, MINE, NEED, NUMBER, MORRISTOWN, DELAY, SOON, BODY, ROLLED, PARTS, TURN, PLAY, OPTION, WHAT, U, V, NUMBERS, ENJOYED, STANDS, WANT, ROLL, FEELER, YOUR, I, THERE, Y, LEG, FEELERS, H, IS, FEET, OF, Z, OBJECT, S, SAME, WILL, CREATIVE, MY, NECK, EACH, HHHHHHH, YOU, BBBBBBBBBBBB, X, AS, NO, NEEDED, TAIL, SEEING, ENJOY, B, C, HEAD, TELL, CAN, TWO, COMPUTING, GET, DIE, GIVE, TTTTTB, BUG, BEFORE, L, PART, F, DO, AGAIN, R, O, N, FINISH, EITHER, HAVE, THIS, Q;
    char _input_buf[256];
...
line_340:
    /* UNTRANSLATED: ON Z GOTO 350,430,540,650,760,870 */
...
line_975:
    DELAY = 1; for_loop_DELAY: if ((1 >= 0 && DELAY > 2000) || (1 < 0 && DELAY < 2000)) goto end_for_DELAY;
    DELAY += 1; goto for_loop_DELAY; end_for_DELAY:;
...
line_990:
    /* UNTRANSLATED: ON X GOTO 1000,1080,1190,1300,1410,1520 */
...
line_1790:
    Z = 1; for_loop_Z: if ((1 >= 0 && Z > 4) || (1 < 0 && Z < 4)) goto end_for_Z;
...
line_1890:
    Z = 1; for_loop_Z: if ((1 >= 0 && Z > 2) || (1 < 0 && Z < 2)) goto end_for_Z;
...
line_2030:
    X = 1; for_loop_X: if ((1 >= 0 && X > L) || (1 < 0 && X < L)) goto end_for_X;
    /* BASIC: 2040 PRINT " L"; */
line_2040:
    printf("%s", " L");
    /* BASIC: 2050 NEXT X */
...
line_2180:
    X = 1; for_loop_X: if ((1 >= 0 && X > S) || (1 < 0 && X < S)) goto end_for_X;
    /* BASIC: 2190 PRINT "F "; */
line_2190:
    printf("%s", "F ");
    /* BASIC: 2200 NEXT X */
...
line_2390:
    X = 1; for_loop_X: if ((1 >= 0 && X > V) || (1 < 0 && X < V)) goto end_for_X;
    /* BASIC: 2400 PRINT " L"; */
line_2400:
    printf("%s", " L");
    /* BASIC: 2410 NEXT X */
